...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      AK: (x0,x1) => { x0.id = x1 },
      AL: x0 => x0.flush(),
      AM: (x0,x1,x2) => x0.addEventListener(x1,x2),
      AN: x0 => x0.isComposing,
      AO: (x0,x1) => x0.item(x1),
      AP: x0 => x0.name,
      ...
      CL: (x0,x1) => x0.bindVertexArray(x1),
      CM: x0 => new ResizeObserver(x0),
      CN: x0 => x0.repeat,
      CO: x0 => x0.length,
      CP: x0 => x0.message,
      ...
      DL: (x0,x1,x2) => x0.bindBuffer(x1,x2),
      DM: (x0,x1) => x0.observe(x1),
      ...
      FN: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      FO: (x0,x1) => { x0.defer = x1 },
      ...
      GN: (x0,x1,x2,x3,x4,x5) => ({clientId: x0,scope: x1,redirectURI: x2,state: x3,nonce: x4,usePopup: x5}),
      GO: (x0,x1) => { x0.async = x1 },
      ...
      HJ: x0 => x0.port1,
      HK: x0 => x0.name,
      HL: (x0,x1,x2,x3,x4) => x0.drawElements(x1,x2,x3,x4),
      HM: (x0,x1) => { x0.pointerEvents = x1 },
      HN: x0 => globalThis.AppleID.auth.init(x0),
      HO: x0 => x0.trustedTypes,
      ...
      IK: x0 => x0.statusText,
      IL: (x0,x1) => x0.blendEquation(x1),
      IM: (x0,x1) => { x0.backgroundColor = x1 },
      IN: () => globalThis.AppleID.auth.signIn(),
      IO: x0 => x0.trustedTypes,
      ...
      JJ: x0 => new Worker(x0),
      JK: x0 => x0.url,
      JL: (x0,x1,x2,x3,x4) => x0.blendFuncSeparate(x1,x2,x3,x4),
      JM: (x0,x1) => { x0.display = x1 },
      JN: x0 => x0.error,
      JO: (wasmFunction,f) => finalizeWrapper(f, function() { return wasmFunction(f,arguments.length) }),
      ...
      KN: x0 => x0.lastName,
      KO: x0 => { globalThis.onGoogleLibraryLoad = x0 },
      ...
      LJ: (o, p, v) => o[p] = v,
      LK: x0 => x0.getReader(),
      LL: (x0,x1) => x0.cullFace(x1),
      LM: (x0,x1) => { x0.width = x1 },
      LN: x0 => x0.firstName,
      LO: x0 => x0.disableAutoSelect(),
      ...
      MK: x0 => x0.read(),
      ML: (x0,x1,x2,x3) => x0.bufferSubData(x1,x2,x3),
      MM: x0 => x0.style,
      MN: x0 => x0.name,
      MO: () => globalThis.google.accounts.id,
      ...
      SK: x0 => x0.signal,
      SL: (x0,x1,x2,x3) => x0.samplerParameteri(x1,x2,x3),
      SM: (x0,x1) => x0.transferFromImageBitmap(x1),
      SN: x0 => x0.authorization,
      SO: (o, p) => p in o,
      SP: (x0,x1) => { x0.text = x1 },
      ...
      TK: x0 => new Blob(x0),
      TL: (x0,x1) => x0.isSampler(x1),
      TM: x0 => x0.height,
      TN: (x0,x1) => x0.getItem(x1),
      TO: x0 => x0.groups,
      TP: (x0,x1) => { x0.text = x1 },
      ...
      UL: (x0,x1) => x0.deleteSampler(x1),
      UM: x0 => x0.width,
      UN: x0 => x0.localStorage,
      ...
      VJ: () => new FileReader(),
      VK: x0 => x0.remove(),
      VL: x0 => x0.createSampler(),
      VM: x0 => x0.rasterEndMilliseconds,
      VN: (x0,x1) => x0.key(x1),
      VO: (x0,x1) => x0.prompt(x1),
      ...
      WL: (x0,x1,x2,x3) => x0.bufferData(x1,x2,x3),
      WM: x0 => x0.rasterStartMilliseconds,
      WN: x0 => x0.length,
      WO: x0 => x0.isSkippedMoment(),
      ...
      XI: x0 => x0.duration,
      XJ: x0 => x0.result,
      XK: (x0,x1) => x0.deleteTexture(x1),
      XL: (x0,x1) => x0.isBuffer(x1),
      XM: x0 => x0.imageBitmaps,
      XN: (x0,x1) => x0.removeItem(x1),
      XO: x0 => x0.getDismissedReason(),
      XP: x0 => x0.message,
      Y: x0 => x0.unicode,
      ...
      YK: (x0,x1) => x0.isTexture(x1),
      YL: x0 => x0.createBuffer(),
      YM: (x0,x1) => { x0.height = x1 },
      YN: (x0,x1,x2) => x0.setItem(x1,x2),
      YO: x0 => x0.isDismissedMoment(),
      ...
      ZK: (x0,x1,x2) => x0.bindTexture(x1,x2),
      ZL: (x0,x1) => x0.getParameter(x1),
      ZM: (x0,x1) => { x0.width = x1 },
      ZN: (x0,x1) => x0.canShare(x1),
      ...
      aK: (x0,x1,x2) => x0.pixelStorei(x1,x2),
      aL: x0 => x0.createProgram(),
      aM: x0 => x0.convertToBlob(),
      aN: (x0,x1) => x0.share(x1),
      aO: (x0,x1,x2) => x0.hasGrantedAllScopes(x1,x2),
      aP: x0 => x0.name,
      b: (exn) => {
      ...
      bK: x0 => x0.close(),
      bL: (x0,x1,x2) => x0.attachShader(x1,x2),
      bM: (x0,x1,x2) => new ImageData(x0,x1,x2),
      bN: x0 => x0.message,
      bO: () => globalThis.google.accounts.oauth2,
      bP: x0 => x0.type,
      c: (c) =>
      ...
      cK: x0 => x0.getError(),
      cL: (x0,x1) => x0.linkProgram(x1),
      cM: (x0,x1) => x0.getContext(x1),
      cN: (o, a) => o + a,
      cO: (x0,x1) => x0.revoke(x1),
      cP: (x0,x1) => x0.item(x1),
      ...
      dK: (x0,x1,x2,x3,x4,x5,x6) => x0.texImage2D(x1,x2,x3,x4,x5,x6),
      dL: (x0,x1,x2) => x0.getProgramParameter(x1,x2),
      dM: (x0,x1) => new OffscreenCanvas(x0,x1),
      dN: (x0,x1,x2) => ({files: x0,title: x1,text: x2}),
      ...
      eJ: x0 => x0.send(),
      eK: (x0,x1,x2,x3) => x0.texParameteri(x1,x2,x3),
      eL: (x0,x1) => x0.getProgramInfoLog(x1),
      eM: x0 => x0.allocationSize(),
      eN: (x0,x1) => ({files: x0,text: x1}),
      eO: (x0,x1,x2) => x0.revoke(x1,x2),
      eP: x0 => x0.files,
      ...
      fI: x0 => x0.completed,
      fJ: x0 => x0.type,
      fK: x0 => x0.createTexture(),
      fL: (x0,x1,x2) => x0.detachShader(x1,x2),
      fM: (x0,x1) => x0.copyTo(x1),
      fN: (x0,x1) => ({files: x0,title: x1}),
      fO: (x0,x1) => x0.getRandomValues(x1),
      fP: (x0,x1) => { x0.multiple = x1 },
      ...
      gJ: x0 => x0.response,
      gK: x0 => x0.height,
      gL: (x0,x1) => x0.deleteShader(x1),
      gM: (x0,x1) => { x0.height = x1 },
      gN: x0 => ({files: x0}),
      gO: (x0,x1,x2,x3) => x0.encrypt(x1,x2,x3),
      gP: (x0,x1) => { x0.accept = x1 },
      ...
      hK: x0 => x0.width,
      hL: (x0,x1) => x0.deleteProgram(x1),
      hM: (x0,x1) => { x0.width = x1 },
      hN: (x0,x1) => ({title: x0,text: x1}),
      hO: x0 => x0.sessionStorage,
      hP: (x0,x1) => { x0.type = x1 },
      i: x0 => new Promise(x0),
      iB: o => {
        if (o === null || o === undefined) return 0;
      ...
      iJ: x0 => x0.vendor,
      iK: (x0,x1,x2) => ({imageOrientation: x0,premultiplyAlpha: x1,colorSpaceConversion: x2}),
      iL: (x0,x1,x2) => x0.getAttribLocation(x1,x2),
      ...
      jJ: x0 => x0.navigator,
      jK: (x0,x1,x2,x3,x4,x5) => ({imageOrientation: x0,premultiplyAlpha: x1,colorSpaceConversion: x2,resizeWidth: x3,resizeHeight: x4,resizeQuality: x5}),
      jL: (x0,x1,x2) => x0.getUniformBlockIndex(x1,x2),
      jM: (x0,x1,x2,x3) => x0.drawImage(x1,x2,x3),
      jN: () => ({}),
      jO: (x0,x1,x2,x3,x4,x5,x6,x7) => x0.unwrapKey(x1,x2,x3,x4,x5,x6,x7),
      jP: x0 => x0.getReader(),
      k: (constructor, args) => {
      ...
      kK: (x0,x1,x2) => x0.createImageBitmap(x1,x2),
      kL: (x0,x1,x2,x3) => x0.getActiveUniformBlockParameter(x1,x2,x3),
      kM: (x0,x1) => x0.getContext(x1),
      kN: (x0,x1,x2) => new File(x0,x1,x2),
      kO: (x0,x1,x2,x3,x4,x5) => x0.importKey(x1,x2,x3,x4,x5),
      kP: x0 => x0.value,
      l: x0 => new Array(x0),
      ...
      lK: x0 => x0.devicePixelRatio,
      lL: (x0,x1,x2,x3) => x0.uniformBlockBinding(x1,x2,x3),
      lM: x0 => x0.format,
      lN: (x0,x1) => { x0.type = x1 },
      lO: (x0,x1,x2,x3) => x0.generateKey(x1,x2,x3),
      lP: x0 => x0.done,
      m: o => [o],
      ...
      mI: x0 => x0.id,
      mJ: x0 => ({type: x0}),
      mK: x0 => x0.clientHeight,
      mL: (x0,x1,x2) => x0.getUniformLocation(x1,x2),
      ...
      mO: (x0,x1,x2,x3,x4) => x0.wrapKey(x1,x2,x3,x4),
      mP: x0 => x0.read(),
      n: (o0, o1) => [o0, o1],
      nB: o => {
        if (o === null || o === undefined) return 0;
      ...
      oJ: (x0,x1) => x0.item(x1),
      oK: (x0,x1,x2) => x0.setAttribute(x1,x2),
      oL: (x0,x1) => x0.createShader(x1),
      ...
      pL: (x0,x1,x2) => x0.shaderSource(x1,x2),
      pM: (x0,x1,x2) => x0.toDataURL(x1,x2),
      pN: (x0,x1) => { x0.type = x1 },
      pO: x0 => x0.isSecureContext,
      pP: x0 => x0.loader,
      q: (x0,x1,x2) => { x0[x1] = x2 },
      ...
      qK: x0 => x0.isContextLost(),
      qL: (x0,x1) => x0.compileShader(x1),
      qM: x0 => x0.abort(),
      qN: x0 => x0.head,
      qO: (x0,x1,x2,x3) => x0.decrypt(x1,x2,x3),
      qP: () => globalThis._flutter,
      r: (o, p) => o[p],
      rB: o => {
        if (o === null || o === undefined) return 0;
      ...
      rI: (x0,x1) => { x0.min = x1 },
      rJ: x0 => x0.click(),
      rK: (x0,x1,x2,x3,x4) => x0.viewport(x1,x2,x3,x4),
      rL: (x0,x1,x2) => x0.getShaderParameter(x1,x2),
      rM: x0 => x0.canvasKitMaximumSurfaces,
      rN: (o) => {
        const typeofValue = typeof o;
        return (typeofValue === 'object') ||
            typeofValue === 'function';
      },
      rO: x0 => x0.measurementId,
      s: () => globalThis,
      ...
      sI: (x0,x1) => { x0.max = x1 },
      sJ: x0 => x0.length,
      sK: (x0,x1,x2,x3,x4) => x0.clearColor(x1,x2,x3,x4),
      sL: (x0,x1) => x0.getShaderInfoLog(x1),
      sM: x0 => x0.nextSibling,
      sN: (x0,x1) => x0.getAttribute(x1),
      sO: x0 => x0.appId,
      ...
      tJ: x0 => x0.children,
      tK: (x0,x1) => x0.clearDepth(x1),
      tL: (x0,x1) => x0.deleteVertexArray(x1),
      tM: (x0,x1) => x0.debug(x1),
      tN: (x0,x1) => x0.debug(x1),
      tO: x0 => x0.messagingSenderId,
      ...
      vK: (x0,x1) => x0.depthFunc(x1),
      vL: (x0,x1) => x0.enableVertexAttribArray(x1),
      vM: x0 => x0.location,
      vN: x0 => ({createScriptURL: x0}),
      vO: x0 => x0.databaseURL,
      w: (l, r) => l === r,
      ...
      wJ: (x0,x1) => { x0.href = x1 },
      wK: (x0,x1) => x0.depthMask(x1),
      wL: (x0,x1,x2,x3,x4,x5,x6) => x0.vertexAttribPointer(x1,x2,x3,x4,x5,x6),
      wM: (x0,x1) => x0.getModifierState(x1),
      wN: (x0,x1,x2) => x0.createPolicy(x1,x2),
      wO: x0 => x0.authDomain,
      x: x0 => x0.random(),
      xB: o => {
        if (o === null || o === undefined) return 0;
      ...
      xK: (x0,x1) => x0.frontFace(x1),
      xL: x0 => x0.createVertexArray(),
      xM: x0 => x0.metaKey,
      xN: (x0,x1) => x0.createScriptURL(x1),
      xO: x0 => x0.projectId,
      y: () => globalThis.Math,
      ...
      zM: x0 => x0.ctrlKey,
      zN: (x0,x1) => x0.querySelectorAll(x1),
      zO: x0 => x0.options,
