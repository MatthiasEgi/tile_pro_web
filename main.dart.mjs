...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      BK: (x0,x1) => { x0.id = x1 },
      BL: (x0,x1,x2) => x0.pixelStorei(x1,x2),
      ...
      DL: (x0,x1,x2,x3,x4,x5,x6) => x0.texImage2D(x1,x2,x3,x4,x5,x6),
      ...
      GL: (x0,x1,x2) => ({imageOrientation: x0,premultiplyAlpha: x1,colorSpaceConversion: x2}),
      ...
      HL: (x0,x1,x2,x3,x4,x5) => ({imageOrientation: x0,premultiplyAlpha: x1,colorSpaceConversion: x2,resizeWidth: x3,resizeHeight: x4,resizeQuality: x5}),
      ...
      IJ: x0 => x0.port1,
      IK: x0 => x0.name,
      IL: (x0,x1,x2) => x0.createImageBitmap(x1,x2),
      ...
      RK: x0 => x0.body,
      RL: (x0,x1,x2) => x0.attachShader(x1,x2),
      ...
      TK: x0 => x0.signal,
      TL: (x0,x1,x2) => x0.getProgramParameter(x1,x2),
      TM: x0 => x0.height,
      TN: x0 => x0.id_token,
      TO: x0 => x0.error,
      ...
      UK: x0 => new Blob(x0),
      UL: (x0,x1) => x0.getProgramInfoLog(x1),
      UM: x0 => x0.width,
      UN: x0 => x0.code,
      UO: x0 => x0.credential,
      UP: (o, p) => delete o[p],
      ...
      VL: (x0,x1,x2) => x0.detachShader(x1,x2),
      ...
      YL: (x0,x1,x2) => x0.getAttribLocation(x1,x2),
      ...
      ZK: (x0,x1) => x0.removeAttribute(x1),
      ZL: (x0,x1,x2) => x0.getUniformBlockIndex(x1,x2),
      ...
      aK: (x0,x1) => x0.deleteTexture(x1),
      aL: (x0,x1,x2,x3) => x0.getActiveUniformBlockParameter(x1,x2,x3),
      ...
      bK: (x0,x1) => x0.clear(x1),
      bL: (x0,x1,x2,x3) => x0.uniformBlockBinding(x1,x2,x3),
      ...
      cK: (x0,x1,x2,x3,x4) => x0.drawElements(x1,x2,x3,x4),
      cL: (x0,x1,x2) => x0.getUniformLocation(x1,x2),
      ...
      dK: (x0,x1) => x0.blendEquation(x1),
      dL: (x0,x1,x2) => x0.uniform1i(x1,x2),
      ...
      eK: (x0,x1,x2,x3,x4) => x0.blendFuncSeparate(x1,x2,x3,x4),
      eL: (x0,x1) => x0.createShader(x1),
      ...
      fJ: x0 => x0.send(),
      fK: (x0,x1) => x0.depthMask(x1),
      fL: (x0,x1,x2) => x0.shaderSource(x1,x2),
      ...
      gI: x0 => x0.frameCount,
      gJ: x0 => x0.type,
      gK: (x0,x1) => x0.enable(x1),
      gL: (x0,x1) => x0.compileShader(x1),
      ...
      hJ: x0 => x0.response,
      hK: (x0,x1) => x0.disable(x1),
      hL: (x0,x1,x2) => x0.getShaderParameter(x1,x2),
      ...
      iK: (x0,x1,x2) => x0.bindSampler(x1,x2),
      iL: (x0,x1) => x0.getShaderInfoLog(x1),
      ...
      jI: x0 => x0.ready,
      jJ: x0 => x0.vendor,
      jK: (x0,x1) => x0.activeTexture(x1),
      jL: (x0,x1) => x0.deleteVertexArray(x1),
      ...
      kI: x0 => x0.tracks,
      kJ: x0 => x0.navigator,
      kK: (x0,x1,x2) => x0.bindTexture(x1,x2),
      kL: (x0,x1) => x0.deleteBuffer(x1),
      ...
      lK: (x0,x1,x2,x3,x4,x5,x6,x7,x8,x9) => x0.texImage2D(x1,x2,x3,x4,x5,x6,x7,x8,x9),
      lL: (x0,x1) => x0.deleteSampler(x1),
      lM: x0 => x0.format,
      lN: x0 => ({text: x0}),
      lO: x0 => x0.subtle,
      lP: x0 => x0.getReader(),
      ...
      mK: (x0,x1,x2,x3) => x0.texParameteri(x1,x2,x3),
      mL: (x0,x1,x2,x3) => x0.samplerParameteri(x1,x2,x3),
      ...
      oK: x0 => x0.createTexture(),
      oL: x0 => x0.createSampler(),
      ...
      pI: x0 => x0.id,
      pJ: (x0,x1) => x0.item(x1),
      pK: (x0,x1) => x0.cullFace(x1),
      pL: (x0,x1,x2,x3) => x0.bufferData(x1,x2,x3),
      ...
      qK: (x0,x1,x2) => x0.bindBuffer(x1,x2),
      qL: (x0,x1) => x0.isBuffer(x1),
      ...
      rK: (x0,x1,x2,x3) => x0.bufferSubData(x1,x2,x3),
      rL: x0 => x0.createBuffer(),
      rM: x0 => x0.arrayBuffer(),
      rN: (x0,x1) => { x0.src = x1 },
      rO: x0 => x0.crypto,
      rP: x0 => x0.loader,
      ...
      sJ: x0 => x0.click(),
      sK: (x0,x1,x2,x3) => x0.bindBufferBase(x1,x2,x3),
      sL: (x0,x1) => x0.getParameter(x1),
      sM: x0 => x0.type,
      sN: (x0,x1) => { x0.type = x1 },
      ...
      tI: x0 => x0.disabled,
      tJ: x0 => x0.length,
      tK: (x0,x1) => x0.bindVertexArray(x1),
      ...
      vK: (x0,x1,x2,x3,x4) => x0.viewport(x1,x2,x3,x4),
      ...
      wK: (x0,x1,x2,x3,x4) => x0.clearColor(x1,x2,x3,x4),
