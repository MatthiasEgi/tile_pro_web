...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      AP: x0 => x0.isSecureContext,
      AQ: () => globalThis._flutter,
      ...
      BN: x0 => x0.format,
      BO: x0 => ({text: x0}),
      BP: (x0,x1,x2,x3) => x0.decrypt(x1,x2,x3),
      ...
      MP: () => globalThis.firebase_core.getApps(),
      N: o => String(o),
      ...
      QP: (x0,x1,x2,x3,x4,x5,x6,x7) => ({apiKey: x0,authDomain: x1,databaseURL: x2,projectId: x3,storageBucket: x4,messagingSenderId: x5,measurementId: x6,appId: x7}),
      R: o => o,
      ...
      RP: (x0,x1) => globalThis.firebase_core.initializeApp(x0,x1),
      S: (s, m) => {
        try {
      ...
      SP: x0 => globalThis.firebase_core.getApp(x0),
      ...
      TO: x0 => x0.nonce,
      TP: () => globalThis.firebase_core.getApp(),
      ...
      UN: x0 => x0.code,
      UO: x0 => x0.document,
      UP: () => globalThis.firebase_core.SDK_VERSION,
      V: o => o,
      ...
      VN: x0 => x0.repeat,
      VO: (x0,x1) => { x0.src = x1 },
      VP: (x0,x1,x2) => globalThis.firebase_core.registerVersion(x0,x1,x2),
      W: o => {
        if (o === undefined || o === null) return 0;
      ...
      WP: (wasmFunction,f) => finalizeWrapper(f, function(x0,x1) { return wasmFunction(f,arguments.length,x0,x1) }),
      X: x0 => x0.dotAll,
      ...
      YP: (x0,x1) => ({createScript: x0,createScriptURL: x1}),
      Z: x0 => x0.ignoreCase,
      ZB: (o, p) => o[p],
      ...
      ZP: (x0,x1) => x0.createScriptURL(x1),
      a: x0 => x0.multiline,
      ...
      aP: (x0,x1,x2) => x0.createScript(x1,x2),
      b: (exn) => {
      ...
      lO: (x0,x1,x2) => x0.hasGrantedAllScopes(x1,x2),
      lP: x0 => x0.name,
      m: o => [o],
      ...
      mO: () => globalThis.google.accounts.oauth2,
      mP: (x0,x1) => x0.item(x1),
      n: (o0, o1) => [o0, o1],
      nB: o => {
        if (o === null || o === undefined) return 0;
      ...
      pN: x0 => x0.length,
      pO: (x0,x1,x2) => x0.revoke(x1,x2),
      pP: (x0,x1) => { x0.multiple = x1 },
      q: (x0,x1,x2) => { x0[x1] = x2 },
      ...
      qO: (x0,x1) => x0.getRandomValues(x1),
      qP: (x0,x1) => { x0.accept = x1 },
      r: (o, p) => o[p],
      rB: o => {
        if (o === null || o === undefined) return 0;
      ...
      rO: (x0,x1,x2,x3) => x0.encrypt(x1,x2,x3),
      rP: (x0,x1) => { x0.type = x1 },
      s: () => globalThis,
      ...
      uN: x0 => x0.message,
      uO: (x0,x1,x2,x3,x4,x5,x6,x7) => x0.unwrapKey(x1,x2,x3,x4,x5,x6,x7),
      uP: x0 => x0.value,
      ...
      vN: (o, a) => o + a,
      vO: (x0,x1,x2,x3,x4,x5) => x0.importKey(x1,x2,x3,x4,x5),
      vP: x0 => x0.done,
      w: (l, r) => l === r,
      ...
      wO: (x0,x1,x2,x3) => x0.generateKey(x1,x2,x3),
      wP: x0 => x0.read(),
      x: x0 => x0.random(),
      xB: o => {
        if (o === null || o === undefined) return 0;
      ...
      xO: (x0,x1,x2,x3,x4) => x0.wrapKey(x1,x2,x3,x4),
      xP: x0 => x0.body,
      y: () => globalThis.Math,
      ...
      yO: (x0,x1,x2) => x0.exportKey(x1,x2),
      yP: x0 => x0.assetBase,
