...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      RK: x0 => x0.body,
      RL: (x0,x1,x2,x3) => x0.samplerParameteri(x1,x2,x3),
      ...
      VL: (x0,x1,x2,x3) => x0.bufferData(x1,x2,x3),
