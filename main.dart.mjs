...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      AK: (x0,x1) => { x0.id = x1 },
      AL: (x0,x1) => x0.cullFace(x1),
      AM: x0 => new ResizeObserver(x0),
      AN: x0 => x0.code,
      AO: x0 => x0.nonce,
      AP: () => globalThis.firebase_core.getApps(),
      ...
      BL: (x0,x1,x2) => x0.bindBuffer(x1,x2),
      BM: (x0,x1) => x0.observe(x1),
      BN: x0 => x0.repeat,
      BO: x0 => x0.length,
      BP: x0 => x0.message,
      ...
      CL: (x0,x1,x2,x3) => x0.bufferSubData(x1,x2,x3),
      CM: x0 => x0.isContextLost(),
      ...
      DL: (x0,x1,x2,x3) => x0.bindBufferBase(x1,x2,x3),
      DM: x0 => x0.preventDefault(),
      DN: x0 => x0.userAgent,
      DO: (x0,x1) => { x0.src = x1 },
      DP: x0 => x0.name,
      E: (exn) => {
      ...
      EJ: x0 => x0.length,
      EK: (x0,x1) => x0.get(x1),
      EL: (x0,x1) => x0.bindVertexArray(x1),
      EM: (x0,x1,x2,x3,x4,x5,x6) => ({alpha: x0,depth: x1,stencil: x2,antialias: x3,premultipliedAlpha: x4,preserveDrawingBuffer: x5,powerPreference: x6}),
      EN: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      EO: (x0,x1) => { x0.defer = x1 },
      EP: (x0,x1,x2,x3,x4,x5,x6,x7) => ({apiKey: x0,authDomain: x1,databaseURL: x2,projectId: x3,storageBucket: x4,messagingSenderId: x5,measurementId: x6,appId: x7}),
      F: () => new Error().stack,
      FB: (o, p, v) => o[p] = v,
      FC: o => {
        if (o === null || o === undefined) return 0;
      ...
      FL: (x0,x1) => x0.useProgram(x1),
      FM: (x0,x1,x2) => x0.getContext(x1,x2),
      FN: (x0,x1,x2,x3,x4,x5) => ({clientId: x0,scope: x1,redirectURI: x2,state: x3,nonce: x4,usePopup: x5}),
      FO: (x0,x1) => { x0.async = x1 },
      FP: (x0,x1) => globalThis.firebase_core.initializeApp(x0,x1),
      ...
      GL: (x0,x1,x2,x3,x4) => x0.viewport(x1,x2,x3,x4),
      GM: (x0,x1) => { x0.pointerEvents = x1 },
      GN: x0 => globalThis.AppleID.auth.init(x0),
      GO: x0 => x0.trustedTypes,
      GP: x0 => globalThis.firebase_core.getApp(x0),
      ...
      HJ: x0 => x0.port1,
      HK: x0 => x0.name,
      HL: (x0,x1,x2,x3,x4) => x0.clearColor(x1,x2,x3,x4),
      HM: (x0,x1) => { x0.backgroundColor = x1 },
      HN: () => globalThis.AppleID.auth.signIn(),
      HO: x0 => x0.trustedTypes,
      HP: () => globalThis.firebase_core.getApp(),
      ...
      IK: x0 => x0.statusText,
      IL: (x0,x1) => x0.clearDepth(x1),
      IM: (x0,x1) => { x0.display = x1 },
      IN: x0 => x0.error,
      IO: (wasmFunction,f) => finalizeWrapper(f, function() { return wasmFunction(f,arguments.length) }),
      IP: () => globalThis.firebase_core.SDK_VERSION,
      ...
      JJ: x0 => new Worker(x0),
      JK: x0 => x0.url,
      JL: (x0,x1) => x0.depthFunc(x1),
      JM: (x0,x1) => { x0.height = x1 },
      JN: x0 => x0.lastName,
      JO: x0 => { globalThis.onGoogleLibraryLoad = x0 },
      JP: (x0,x1,x2) => globalThis.firebase_core.registerVersion(x0,x1,x2),
      K: o => o,
      ...
      KK: x0 => x0.status,
      KL: (x0,x1) => x0.frontFace(x1),
      KM: (x0,x1) => { x0.width = x1 },
      KN: x0 => x0.firstName,
      KO: x0 => x0.disableAutoSelect(),
      KP: (wasmFunction,f) => finalizeWrapper(f, function(x0,x1) { return wasmFunction(f,arguments.length,x0,x1) }),
      L: o => {
      ...
      LM: x0 => x0.style,
      LN: x0 => x0.name,
      LO: () => globalThis.google.accounts.id,
      ...
      MM: x0 => x0.disconnect(),
      MN: x0 => x0.email,
      MO: (x0,x1) => x0.initialize(x1),
      MP: (x0,x1) => ({createScript: x0,createScriptURL: x1}),
      N: o => String(o),
      ...
      OP: (x0,x1,x2) => x0.createScript(x1,x2),
      P: (x0,x1) => x0.exec(x1),
      ...
      PJ: x0 => x0.port,
      PK: x0 => x0.cancel(),
      PL: (x0,x1) => x0.deleteBuffer(x1),
      PM: (x0,x1,x2,x3) => x0.putImageData(x1,x2,x3),
      PN: x0 => x0.id_token,
      PO: x0 => x0.error,
      ...
      QK: x0 => x0.body,
      QL: (x0,x1,x2,x3) => x0.samplerParameteri(x1,x2,x3),
      QM: x0 => x0.arrayBuffer(),
      QN: x0 => x0.code,
      QO: x0 => x0.credential,
      QP: (o, p) => delete o[p],
      R: o => o,
      ...
      RK: x0 => x0.headers,
      RL: (x0,x1) => x0.isSampler(x1),
      RM: (x0,x1) => x0.transferFromImageBitmap(x1),
      ...
      UL: (x0,x1,x2,x3) => x0.bufferData(x1,x2,x3),
      UM: x0 => x0.rasterEndMilliseconds,
      UN: (x0,x1) => x0.key(x1),
      UO: (x0,x1) => x0.prompt(x1),
      UP: (x0,x1) => { x0.crossOrigin = x1 },
      V: o => o,
      ...
      VJ: () => new FileReader(),
      VK: x0 => x0.remove(),
      VL: (x0,x1) => x0.isBuffer(x1),
      VM: x0 => x0.rasterStartMilliseconds,
      VN: x0 => x0.length,
      VO: x0 => x0.isSkippedMoment(),
      ...
      WL: x0 => x0.createBuffer(),
      WM: x0 => x0.imageBitmaps,
      WN: (x0,x1) => x0.removeItem(x1),
      WO: x0 => x0.getDismissedReason(),
      WP: x0 => x0.message,
      X: x0 => x0.dotAll,
      ...
      XL: (x0,x1) => x0.getParameter(x1),
      XM: (x0,x1) => { x0.height = x1 },
      XN: (x0,x1,x2) => x0.setItem(x1,x2),
      XO: x0 => x0.isDismissedMoment(),
      XP: x0 => x0.lastModified,
      Y: x0 => x0.unicode,
      ...
      YL: x0 => x0.createProgram(),
      YM: (x0,x1) => { x0.width = x1 },
      YN: (x0,x1) => x0.canShare(x1),
      YO: x0 => x0.access_token,
      YP: x0 => x0.size,
      Z: x0 => x0.ignoreCase,
      ZB: (o, p) => o[p],
      ...
      ZL: (x0,x1,x2) => x0.attachShader(x1,x2),
      ZM: x0 => x0.convertToBlob(),
      ZN: (x0,x1) => x0.share(x1),
      ZO: (x0,x1,x2) => x0.hasGrantedAllScopes(x1,x2),
      ZP: x0 => x0.name,
      a: x0 => x0.multiline,
      ...
      aL: (x0,x1) => x0.linkProgram(x1),
      aM: (x0,x1,x2) => new ImageData(x0,x1,x2),
      aN: x0 => x0.message,
      aO: () => globalThis.google.accounts.oauth2,
      aP: x0 => x0.type,
      b: (exn) => {
      ...
      bK: x0 => x0.close(),
      bL: (x0,x1,x2) => x0.getProgramParameter(x1,x2),
      bM: (x0,x1) => x0.getContext(x1),
      bN: (o, a) => o + a,
      bO: (x0,x1) => x0.revoke(x1),
      bP: (x0,x1) => x0.item(x1),
      c: (c) =>
      ...
      cK: x0 => x0.getError(),
      cL: (x0,x1) => x0.getProgramInfoLog(x1),
      cM: (x0,x1) => new OffscreenCanvas(x0,x1),
      cN: (x0,x1,x2) => ({files: x0,title: x1,text: x2}),
      ...
      dL: (x0,x1,x2) => x0.detachShader(x1,x2),
      dM: x0 => x0.allocationSize(),
      dN: (x0,x1) => ({files: x0,text: x1}),
      dO: (x0,x1,x2) => x0.revoke(x1,x2),
      dP: x0 => x0.files,
      ...
      eL: (x0,x1) => x0.deleteShader(x1),
      eM: (x0,x1) => x0.copyTo(x1),
      eN: (x0,x1) => ({files: x0,title: x1}),
      eO: (x0,x1) => x0.getRandomValues(x1),
      eP: (x0,x1) => { x0.multiple = x1 },
      ...
      fL: (x0,x1) => x0.deleteProgram(x1),
      fM: (x0,x1) => { x0.height = x1 },
      fN: x0 => ({files: x0}),
      fO: (x0,x1,x2,x3) => x0.encrypt(x1,x2,x3),
      ...
      gJ: x0 => x0.response,
      gK: x0 => x0.height,
      gL: (x0,x1,x2) => x0.getAttribLocation(x1,x2),
      gM: (x0,x1) => { x0.width = x1 },
      gN: (x0,x1) => ({title: x0,text: x1}),
      gO: x0 => x0.sessionStorage,
      gP: (x0,x1) => { x0.type = x1 },
      ...
      hK: x0 => x0.width,
      hL: (x0,x1,x2) => x0.getUniformBlockIndex(x1,x2),
      hM: (x0,x1) => x0.toDataURL(x1),
      hN: x0 => ({text: x0}),
      hO: x0 => x0.subtle,
      hP: x0 => x0.length,
      i: x0 => new Promise(x0),
      ...
      iL: (x0,x1,x2,x3) => x0.getActiveUniformBlockParameter(x1,x2,x3),
      iM: (x0,x1,x2,x3) => x0.drawImage(x1,x2,x3),
      iN: () => ({}),
      iO: (x0,x1,x2,x3,x4,x5,x6,x7) => x0.unwrapKey(x1,x2,x3,x4,x5,x6,x7),
      iP: x0 => x0.getReader(),
      ...
      jL: (x0,x1,x2,x3) => x0.uniformBlockBinding(x1,x2,x3),
      jM: (x0,x1) => x0.getContext(x1),
      jN: (x0,x1,x2) => new File(x0,x1,x2),
      jO: (x0,x1,x2,x3,x4,x5) => x0.importKey(x1,x2,x3,x4,x5),
      jP: x0 => x0.value,
      k: (constructor, args) => {
      ...
      kL: (x0,x1,x2) => x0.getUniformLocation(x1,x2),
      kM: x0 => x0.format,
      kN: (x0,x1) => { x0.type = x1 },
      kO: (x0,x1,x2,x3) => x0.generateKey(x1,x2,x3),
      kP: x0 => x0.done,
      l: x0 => new Array(x0),
      ...
      lL: (x0,x1,x2) => x0.uniform1i(x1,x2),
      lM: (x0,x1) => x0.createImageBitmap(x1),
      lN: (wasmFunction,f) => finalizeWrapper(f, function(x0) { return wasmFunction(f,arguments.length,x0) }),
      lO: (x0,x1,x2,x3,x4) => x0.wrapKey(x1,x2,x3,x4),
      lP: x0 => x0.read(),
      m: o => [o],
      ...
      nL: (x0,x1,x2) => x0.shaderSource(x1,x2),
      nM: (x0,x1,x2,x3) => x0.drawImage(x1,x2,x3),
      nN: (x0,x1) => { x0.src = x1 },
      nO: x0 => x0.crypto,
      nP: x0 => x0.assetBase,
      o: (o0, o1, o2) => [o0, o1, o2],
      ...
      oL: (x0,x1) => x0.compileShader(x1),
      oM: (x0,x1,x2) => x0.toDataURL(x1,x2),
      oN: (x0,x1) => { x0.type = x1 },
      oO: x0 => x0.isSecureContext,
      oP: x0 => x0.loader,
      ...
      pL: (x0,x1,x2) => x0.getShaderParameter(x1,x2),
      pM: x0 => x0.abort(),
      pN: x0 => x0.head,
      pO: (x0,x1,x2,x3) => x0.decrypt(x1,x2,x3),
      pP: () => globalThis._flutter,
      q: (x0,x1,x2) => { x0[x1] = x2 },
      ...
      qK: (x0,x1) => x0.clear(x1),
      qL: (x0,x1) => x0.getShaderInfoLog(x1),
      ...
      rI: (x0,x1) => { x0.min = x1 },
      rJ: x0 => x0.click(),
      rK: (x0,x1,x2,x3,x4) => x0.drawElements(x1,x2,x3,x4),
      rL: (x0,x1) => x0.deleteVertexArray(x1),
      rM: x0 => x0.nextSibling,
      rN: (x0,x1) => x0.getAttribute(x1),
      rO: x0 => x0.appId,
      s: () => globalThis,
      ...
      sI: (x0,x1) => { x0.max = x1 },
      sJ: x0 => x0.length,
      sK: (x0,x1) => x0.blendEquation(x1),
      sL: (x0,x1) => x0.isVertexArray(x1),
      sM: (x0,x1) => x0.debug(x1),
      sN: (x0,x1) => x0.debug(x1),
      sO: x0 => x0.messagingSenderId,
      ...
      tJ: x0 => x0.children,
      tK: (x0,x1,x2,x3,x4) => x0.blendFuncSeparate(x1,x2,x3,x4),
      tL: (x0,x1) => x0.enableVertexAttribArray(x1),
      tM: x0 => x0.hostElement,
      tN: (wasmFunction,f) => finalizeWrapper(f, function(x0) { return wasmFunction(f,arguments.length,x0) }),
      tO: x0 => x0.storageBucket,
      ...
      uK: (x0,x1) => x0.depthMask(x1),
      uL: (x0,x1,x2,x3,x4,x5,x6) => x0.vertexAttribPointer(x1,x2,x3,x4,x5,x6),
      uM: x0 => x0.location,
      uN: x0 => ({createScriptURL: x0}),
      uO: x0 => x0.databaseURL,
      ...
      vK: (x0,x1) => x0.enable(x1),
      vL: x0 => x0.createVertexArray(),
      vM: (x0,x1) => x0.getModifierState(x1),
      vN: (x0,x1,x2) => x0.createPolicy(x1,x2),
      vO: x0 => x0.authDomain,
      w: (l, r) => l === r,
      ...
      yK: (x0,x1) => x0.activeTexture(x1),
      yL: (x0,x1,x2) => x0.addEventListener(x1,x2),
      yM: x0 => x0.ctrlKey,
      yN: (x0,x1) => x0.querySelectorAll(x1),
      yO: x0 => x0.options,
