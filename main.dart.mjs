...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      AI: x0 => x0.next(),
      AJ: () => new MessageChannel(),
      AK: x0 => x0.body,
      AL: (x0,x1,x2,x3,x4,x5,x6,x7,x8,x9) => x0.texImage2D(x1,x2,x3,x4,x5,x6,x7,x8,x9),
      AM: (wasmFunction,f) => finalizeWrapper(f, function(x0,x1) { return wasmFunction(f,arguments.length,x0,x1) }),
      AN: x0 => x0.metaKey,
      AO: (x0,x1) => x0.createScriptURL(x1),
      AP: x0 => x0.projectId,
      ...
      BK: (x0,x1) => { x0.id = x1 },
      BL: (x0,x1) => x0.cullFace(x1),
      BM: x0 => new ResizeObserver(x0),
      BN: x0 => x0.altKey,
      BO: (x0,x1) => { x0.nonce = x1 },
      BP: x0 => x0.apiKey,
      ...
      CI: x0 => x0.done,
      CJ: x0 => x0.port2,
      CK: () => new AbortController(),
      CL: (x0,x1,x2) => x0.bindBuffer(x1,x2),
      CM: (x0,x1) => x0.observe(x1),
      CN: x0 => x0.ctrlKey,
      CO: (x0,x1) => x0.querySelectorAll(x1),
      CP: x0 => x0.options,
      ...
      DK: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      DL: (x0,x1,x2,x3) => x0.bufferSubData(x1,x2,x3),
      DM: x0 => x0.isContextLost(),
      DN: x0 => x0.isComposing,
      DO: (x0,x1) => x0.item(x1),
      DP: x0 => x0.name,
      E: (exn) => {
      ...
      EI: x0 => x0.iterator,
      EJ: x0 => globalThis.Object.keys(x0),
      EK: (x0,x1) => globalThis.fetch(x0,x1),
      EL: (x0,x1,x2,x3) => x0.bindBufferBase(x1,x2,x3),
      EM: x0 => x0.preventDefault(),
      EN: x0 => x0.code,
      EO: x0 => x0.nonce,
      EP: () => globalThis.firebase_core.getApps(),
      F: () => new Error().stack,
      FB: (o, p, v) => o[p] = v,
      FC: o => {
        if (o === null || o === undefined) return 0;
      ...
      FJ: x0 => x0.length,
      FK: (x0,x1) => x0.get(x1),
      FL: (x0,x1) => x0.bindVertexArray(x1),
      FM: (x0,x1,x2,x3,x4,x5,x6) => ({alpha: x0,depth: x1,stencil: x2,antialias: x3,premultipliedAlpha: x4,preserveDrawingBuffer: x5,powerPreference: x6}),
      FN: x0 => x0.repeat,
      FO: x0 => x0.length,
      FP: x0 => x0.message,
      ...
      GL: (x0,x1) => x0.useProgram(x1),
      GM: (x0,x1,x2) => x0.getContext(x1,x2),
      ...
      HI: x0 => x0.Segmenter,
      HJ: x0 => x0.data,
      HK: (x0,x1) => x0.forEach(x1),
      HL: (x0,x1,x2,x3,x4) => x0.viewport(x1,x2,x3,x4),
      HM: (x0,x1) => { x0.pointerEvents = x1 },
      HN: x0 => x0.userAgent,
      HO: (x0,x1) => { x0.src = x1 },
      HP: x0 => x0.name,
      ...
      IJ: x0 => x0.port1,
      IK: x0 => x0.name,
      IL: (x0,x1,x2,x3,x4) => x0.clearColor(x1,x2,x3,x4),
      IM: (x0,x1) => { x0.backgroundColor = x1 },
      IN: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      IO: (x0,x1) => { x0.defer = x1 },
      IP: (x0,x1,x2,x3,x4,x5,x6,x7) => ({apiKey: x0,authDomain: x1,databaseURL: x2,projectId: x3,storageBucket: x4,messagingSenderId: x5,measurementId: x6,appId: x7}),
      ...
      JH: x0 => x0.unlock(),
      JI: (a, i) => a.splice(i, 1),
      JJ: (x0,x1) => new SharedWorker(x0,x1),
      JK: x0 => x0.statusText,
      JL: (x0,x1) => x0.clearDepth(x1),
      JM: (x0,x1) => { x0.display = x1 },
      JN: (x0,x1,x2,x3,x4,x5) => ({clientId: x0,scope: x1,redirectURI: x2,state: x3,nonce: x4,usePopup: x5}),
      JO: (x0,x1) => { x0.async = x1 },
      JP: (x0,x1) => globalThis.firebase_core.initializeApp(x0,x1),
      K: o => o,
      ...
      KJ: x0 => new Worker(x0),
      KK: x0 => x0.url,
      KL: (x0,x1) => x0.depthFunc(x1),
      KM: (x0,x1) => { x0.height = x1 },
      KN: x0 => globalThis.AppleID.auth.init(x0),
      KO: x0 => x0.trustedTypes,
      KP: x0 => globalThis.firebase_core.getApp(x0),
      L: o => {
      ...
      LK: x0 => x0.status,
      LL: (x0,x1) => x0.frontFace(x1),
      LM: (x0,x1) => { x0.width = x1 },
      LN: () => globalThis.AppleID.auth.signIn(),
      LO: x0 => x0.trustedTypes,
      LP: () => globalThis.firebase_core.getApp(),
      M: x0 => x0.index,
      ...
      MJ: (o, p, v) => o[p] = v,
      MK: x0 => x0.getReader(),
      ML: (x0,x1) => x0.deleteBuffer(x1),
      MM: x0 => x0.style,
      MN: x0 => x0.error,
      MO: (wasmFunction,f) => finalizeWrapper(f, function() { return wasmFunction(f,arguments.length) }),
      MP: () => globalThis.firebase_core.SDK_VERSION,
      N: o => String(o),
      ...
      NK: x0 => x0.read(),
      NL: (x0,x1,x2,x3) => x0.samplerParameteri(x1,x2,x3),
      NM: x0 => x0.disconnect(),
      NN: x0 => x0.lastName,
      NO: x0 => { globalThis.onGoogleLibraryLoad = x0 },
      NP: (x0,x1,x2) => globalThis.firebase_core.registerVersion(x0,x1,x2),
      O: o => o === undefined,
      ...
      OK: x0 => x0.value,
      OL: (x0,x1) => x0.isSampler(x1),
      OM: (x0,x1,x2) => x0.removeEventListener(x1,x2),
      ON: x0 => x0.firstName,
      OO: x0 => x0.disableAutoSelect(),
      ...
      PI: x0 => x0.decode(),
      PJ: (x0,x1,x2) => x0.postMessage(x1,x2),
      PK: x0 => x0.done,
      PL: (x0,x1) => x0.deleteSampler(x1),
      PM: x0 => x0.firstElementChild,
      PN: x0 => x0.name,
      PO: () => globalThis.google.accounts.id,
      ...
      QJ: x0 => x0.port,
      QK: x0 => x0.cancel(),
      QL: x0 => x0.createSampler(),
      QM: (x0,x1,x2,x3) => x0.putImageData(x1,x2,x3),
      QN: x0 => x0.email,
      QO: (x0,x1) => x0.initialize(x1),
      QP: (x0,x1) => ({createScript: x0,createScriptURL: x1}),
      R: o => o,
      ...
      RJ: (x0,x1) => { x0.onerror = x1 },
      RK: x0 => x0.body,
      RL: (x0,x1,x2,x3) => x0.bufferData(x1,x2,x3),
      RM: x0 => x0.arrayBuffer(),
      RN: x0 => x0.user,
      RO: (wasmFunction,f) => finalizeWrapper(f, function(x0) { return wasmFunction(f,arguments.length,x0) }),
      RP: (x0,x1) => x0.createScriptURL(x1),
      S: (s, m) => {
        try {
      ...
      SP: (x0,x1,x2) => x0.createScript(x1,x2),
      ...
      TH: x0 => x0.content,
      TI: x0 => x0.URL,
      TJ: (x0,x1) => x0.getRandomValues(x1),
      TK: x0 => x0.signal,
      TL: x0 => x0.createBuffer(),
      TM: x0 => x0.height,
      TN: x0 => x0.id_token,
      TO: x0 => x0.error,
      ...
      UH: x0 => x0.document,
      UI: x0 => new Blob(x0),
      UJ: () => globalThis.crypto,
      UK: x0 => new Blob(x0),
      UL: (x0,x1) => x0.getParameter(x1),
      UM: x0 => x0.width,
      UN: x0 => x0.code,
      UO: x0 => x0.credential,
      UP: (o, p) => delete o[p],
      ...
      VI: x0 => x0.close(),
      VJ: l => new DataView(new ArrayBuffer(l)),
      VK: (x0,x1) => x0.append(x1),
      VL: (x0,x1) => { x0.height = x1 },
      VM: x0 => x0.rasterEndMilliseconds,
      VN: x0 => x0.authorization,
      VO: (o, p) => p in o,
      VP: (x0,x1) => { x0.text = x1 },
      W: o => {
        if (o === undefined || o === null) return 0;
      ...
      WM: x0 => x0.rasterStartMilliseconds,
      WN: (x0,x1) => x0.getItem(x1),
      WO: x0 => x0.groups,
      WP: (x0,x1) => { x0.text = x1 },
      X: x0 => x0.dotAll,
      ...
      XK: x0 => globalThis.URL.revokeObjectURL(x0),
      XL: x0 => x0.height,
      XM: x0 => x0.imageBitmaps,
      XN: x0 => x0.localStorage,
      XO: (wasmFunction,f) => finalizeWrapper(f, function(x0) { return wasmFunction(f,arguments.length,x0) }),
      XP: x0 => x0.trustedTypes,
      Y: x0 => x0.unicode,
      ...
      YJ: x0 => x0.result,
      YK: (x0,x1) => x0.deleteTexture(x1),
      YL: x0 => x0.width,
      YM: (x0,x1) => { x0.height = x1 },
      YN: (x0,x1) => x0.key(x1),
      YO: (x0,x1) => x0.prompt(x1),
      YP: (x0,x1) => { x0.crossOrigin = x1 },
      Z: x0 => x0.ignoreCase,
      ZB: (o, p) => o[p],
      ...
      ZK: (x0,x1) => x0.isTexture(x1),
      ZL: x0 => x0.createProgram(),
      ZM: (x0,x1) => { x0.width = x1 },
      ZN: x0 => x0.length,
      ZO: x0 => x0.isSkippedMoment(),
      ...
      aK: (x0,x1,x2) => x0.bindTexture(x1,x2),
      aL: (x0,x1,x2) => x0.attachShader(x1,x2),
      aM: x0 => x0.convertToBlob(),
      aN: (x0,x1) => x0.removeItem(x1),
      aO: x0 => x0.getDismissedReason(),
      aP: x0 => x0.message,
      b: (exn) => {
      ...
      bK: (x0,x1,x2) => x0.pixelStorei(x1,x2),
      bL: (x0,x1) => x0.linkProgram(x1),
      bM: (x0,x1,x2) => new ImageData(x0,x1,x2),
      bN: (x0,x1,x2) => x0.setItem(x1,x2),
      bO: x0 => x0.isDismissedMoment(),
      bP: x0 => x0.lastModified,
      c: (c) =>
      ...
      cK: x0 => x0.close(),
      cL: (x0,x1,x2) => x0.getProgramParameter(x1,x2),
      cM: (x0,x1) => x0.getContext(x1),
      cN: (x0,x1) => x0.canShare(x1),
      cO: x0 => x0.access_token,
      cP: x0 => x0.size,
      ...
      dK: x0 => x0.getError(),
      dL: (x0,x1) => x0.getProgramInfoLog(x1),
      dM: (x0,x1) => new OffscreenCanvas(x0,x1),
      dN: (x0,x1) => x0.share(x1),
      dO: (x0,x1,x2) => x0.hasGrantedAllScopes(x1,x2),
      dP: x0 => x0.name,
      ...
      eK: (x0,x1,x2,x3,x4,x5,x6) => x0.texImage2D(x1,x2,x3,x4,x5,x6),
      eL: (x0,x1,x2) => x0.detachShader(x1,x2),
      eM: x0 => x0.allocationSize(),
      eN: x0 => x0.message,
      eO: () => globalThis.google.accounts.oauth2,
      eP: (x0,x1) => x0.item(x1),
      ...
      fJ: x0 => x0.send(),
      fK: (x0,x1,x2,x3) => x0.texParameteri(x1,x2,x3),
      fL: (x0,x1) => x0.deleteShader(x1),
      fM: (x0,x1) => x0.copyTo(x1),
      fN: (o, a) => o + a,
      fO: (x0,x1) => x0.revoke(x1),
      fP: x0 => x0.length,
      ...
      gI: x0 => x0.frameCount,
      gJ: x0 => x0.type,
      gK: x0 => x0.createTexture(),
      gL: (x0,x1) => x0.deleteProgram(x1),
      gM: (x0,x1) => { x0.height = x1 },
      gN: (x0,x1,x2) => ({files: x0,title: x1,text: x2}),
      ...
      hJ: x0 => x0.response,
      hK: x0 => x0.height,
      hL: (x0,x1,x2) => x0.getAttribLocation(x1,x2),
      hM: (x0,x1) => { x0.width = x1 },
      hN: (x0,x1) => ({files: x0,text: x1}),
      hO: (x0,x1,x2) => x0.revoke(x1,x2),
      hP: (x0,x1) => { x0.multiple = x1 },
      i: x0 => new Promise(x0),
      iB: o => {
        if (o === null || o === undefined) return 0;
      ...
      iK: x0 => x0.width,
      iL: (x0,x1,x2) => x0.getUniformBlockIndex(x1,x2),
      iM: (x0,x1) => x0.toDataURL(x1),
      iN: (x0,x1) => ({files: x0,title: x1}),
      iO: (x0,x1) => x0.getRandomValues(x1),
      iP: (x0,x1) => { x0.accept = x1 },
      ...
      jI: x0 => x0.ready,
      jJ: x0 => x0.vendor,
      jK: (x0,x1,x2) => ({imageOrientation: x0,premultiplyAlpha: x1,colorSpaceConversion: x2}),
      jL: (x0,x1,x2,x3) => x0.getActiveUniformBlockParameter(x1,x2,x3),
      jM: (x0,x1,x2,x3) => x0.drawImage(x1,x2,x3),
      jN: x0 => ({files: x0}),
      jO: (x0,x1,x2,x3) => x0.encrypt(x1,x2,x3),
      jP: (x0,x1) => { x0.type = x1 },
      k: (constructor, args) => {
      ...
      kI: x0 => x0.tracks,
      kJ: x0 => x0.navigator,
      kK: (x0,x1,x2,x3,x4,x5) => ({imageOrientation: x0,premultiplyAlpha: x1,colorSpaceConversion: x2,resizeWidth: x3,resizeHeight: x4,resizeQuality: x5}),
      kL: (x0,x1,x2,x3) => x0.uniformBlockBinding(x1,x2,x3),
      kM: (x0,x1) => x0.getContext(x1),
      kN: (x0,x1) => ({title: x0,text: x1}),
      kO: x0 => x0.sessionStorage,
      kP: x0 => x0.length,
      l: x0 => new Array(x0),
      ...
      lK: (x0,x1,x2) => x0.createImageBitmap(x1,x2),
      lL: (x0,x1,x2) => x0.getUniformLocation(x1,x2),
      lM: x0 => x0.format,
      lN: x0 => ({text: x0}),
      lO: x0 => x0.subtle,
      lP: x0 => x0.getReader(),
      ...
      mJ: x0 => globalThis.URL.createObjectURL(x0),
      mK: x0 => x0.devicePixelRatio,
      mL: (x0,x1,x2) => x0.uniform1i(x1,x2),
      mM: (x0,x1) => x0.createImageBitmap(x1),
      mN: () => ({}),
      mO: (x0,x1,x2,x3,x4,x5,x6,x7) => x0.unwrapKey(x1,x2,x3,x4,x5,x6,x7),
      mP: x0 => x0.value,
      n: (o0, o1) => [o0, o1],
      nB: o => {
        if (o === null || o === undefined) return 0;
      ...
      nJ: x0 => ({type: x0}),
      nK: x0 => x0.clientHeight,
      nL: (x0,x1) => x0.createShader(x1),
      nM: (x0,x1) => x0.getContext(x1),
      nN: (x0,x1,x2) => new File(x0,x1,x2),
      nO: (x0,x1,x2,x3,x4,x5) => x0.importKey(x1,x2,x3,x4,x5),
      nP: x0 => x0.done,
      o: (o0, o1, o2) => [o0, o1, o2],
      ...
      oJ: (x0,x1) => new Blob(x0,x1),
      oK: x0 => x0.clientWidth,
      oL: (x0,x1,x2) => x0.shaderSource(x1,x2),
      oM: (x0,x1,x2,x3) => x0.drawImage(x1,x2,x3),
      oN: (x0,x1) => { x0.type = x1 },
      oO: (x0,x1,x2,x3) => x0.generateKey(x1,x2,x3),
      oP: x0 => x0.read(),
      ...
      pI: x0 => x0.id,
      pJ: (x0,x1) => x0.item(x1),
      pK: (x0,x1,x2) => x0.setAttribute(x1,x2),
      pL: (x0,x1) => x0.compileShader(x1),
      ...
      pO: (x0,x1,x2,x3,x4) => x0.wrapKey(x1,x2,x3,x4),
      pP: x0 => x0.body,
      q: (x0,x1,x2) => { x0[x1] = x2 },
      ...
      qL: (x0,x1,x2) => x0.getShaderParameter(x1,x2),
      qM: (x0,x1,x2,x3) => x0.toBlob(x1,x2,x3),
      qN: (wasmFunction,f) => finalizeWrapper(f, function(x0) { return wasmFunction(f,arguments.length,x0) }),
      qO: (x0,x1,x2) => x0.exportKey(x1,x2),
      qP: x0 => x0.assetBase,
      r: (o, p) => o[p],
      rB: o => {
        if (o === null || o === undefined) return 0;
      ...
      rK: (x0,x1) => x0.clear(x1),
      rL: (x0,x1) => x0.getShaderInfoLog(x1),
      rM: x0 => x0.arrayBuffer(),
      rN: (x0,x1) => { x0.src = x1 },
      rO: x0 => x0.crypto,
      rP: x0 => x0.loader,
      ...
      sJ: x0 => x0.click(),
      sK: (x0,x1,x2,x3,x4) => x0.drawElements(x1,x2,x3,x4),
      sL: (x0,x1) => x0.deleteVertexArray(x1),
      sM: x0 => x0.type,
      sN: (x0,x1) => { x0.type = x1 },
      sO: x0 => x0.isSecureContext,
      sP: () => globalThis._flutter,
      ...
      tI: x0 => x0.disabled,
      tJ: x0 => x0.length,
      tK: (x0,x1) => x0.blendEquation(x1),
      tL: (x0,x1) => x0.isVertexArray(x1),
      tM: x0 => x0.abort(),
      tN: x0 => x0.head,
      tO: (x0,x1,x2,x3) => x0.decrypt(x1,x2,x3),
      ...
      uI: (x0,x1) => { x0.min = x1 },
      uJ: x0 => x0.children,
      uK: (x0,x1,x2,x3,x4) => x0.blendFuncSeparate(x1,x2,x3,x4),
      uL: (x0,x1) => x0.enableVertexAttribArray(x1),
      uM: x0 => x0.canvasKitMaximumSurfaces,
      uN: (o) => {
        const typeofValue = typeof o;
        return (typeofValue === 'object') ||
            typeofValue === 'function';
      },
      uO: x0 => x0.measurementId,
      ...
      vK: (x0,x1) => x0.depthMask(x1),
      vL: (x0,x1,x2,x3,x4,x5,x6) => x0.vertexAttribPointer(x1,x2,x3,x4,x5,x6),
      vM: x0 => x0.nextSibling,
      vN: (x0,x1) => x0.getAttribute(x1),
      vO: x0 => x0.appId,
      w: (l, r) => l === r,
      ...
      wK: (x0,x1) => x0.enable(x1),
      wL: x0 => x0.createVertexArray(),
      wM: (x0,x1) => x0.debug(x1),
      wN: (x0,x1) => x0.debug(x1),
      wO: x0 => x0.messagingSenderId,
      x: x0 => x0.random(),
      xB: o => {
        if (o === null || o === undefined) return 0;
      ...
      zK: (x0,x1) => x0.activeTexture(x1),
      zL: (x0,x1,x2) => x0.addEventListener(x1,x2),
      zM: (x0,x1) => x0.getModifierState(x1),
      zN: (x0,x1,x2) => x0.createPolicy(x1,x2),
      zO: x0 => x0.authDomain,
