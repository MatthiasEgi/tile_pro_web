...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      BN: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      BO: (x0,x1) => { x0.defer = x1 },
      BP: (x0,x1,x2,x3,x4,x5,x6,x7) => ({apiKey: x0,authDomain: x1,databaseURL: x2,projectId: x3,storageBucket: x4,messagingSenderId: x5,measurementId: x6,appId: x7}),
      ...
      CN: (x0,x1,x2,x3,x4,x5) => ({clientId: x0,scope: x1,redirectURI: x2,state: x3,nonce: x4,usePopup: x5}),
      CO: (x0,x1) => { x0.async = x1 },
      CP: (x0,x1) => globalThis.firebase_core.initializeApp(x0,x1),
      ...
      DN: x0 => globalThis.AppleID.auth.init(x0),
      DO: x0 => x0.trustedTypes,
      DP: x0 => globalThis.firebase_core.getApp(x0),
      E: (exn) => {
      ...
      EN: () => globalThis.AppleID.auth.signIn(),
      EO: x0 => x0.trustedTypes,
      EP: () => globalThis.firebase_core.getApp(),
      F: () => new Error().stack,
      FB: (o, p, v) => o[p] = v,
      FC: o => {
        if (o === null || o === undefined) return 0;
      ...
      FP: () => globalThis.firebase_core.SDK_VERSION,
      ...
      GP: (x0,x1,x2) => globalThis.firebase_core.registerVersion(x0,x1,x2),
      ...
      IN: x0 => x0.name,
      IO: () => globalThis.google.accounts.id,
      ...
      JP: (x0,x1) => ({createScript: x0,createScriptURL: x1}),
      K: o => o,
      ...
      KP: (x0,x1) => x0.createScriptURL(x1),
      L: o => {
      ...
      LP: (x0,x1,x2) => x0.createScript(x1,x2),
      M: x0 => x0.index,
      ...
      RN: (x0,x1) => x0.key(x1),
      RO: (x0,x1) => x0.prompt(x1),
      RP: (x0,x1) => { x0.crossOrigin = x1 },
      S: (s, m) => {
        try {
      ...
      TM: x0 => x0.height,
      TN: (x0,x1) => x0.removeItem(x1),
      TO: x0 => x0.getDismissedReason(),
      TP: x0 => x0.message,
      ...
      UM: x0 => x0.width,
      UN: (x0,x1,x2) => x0.setItem(x1,x2),
      UO: x0 => x0.isDismissedMoment(),
      UP: x0 => x0.lastModified,
      V: o => o,
      ...
      WO: (x0,x1,x2) => x0.hasGrantedAllScopes(x1,x2),
      WP: x0 => x0.name,
      X: x0 => x0.dotAll,
      ...
      XN: x0 => x0.message,
      XO: () => globalThis.google.accounts.oauth2,
      XP: x0 => x0.type,
      Y: x0 => x0.unicode,
      ...
      ZN: (x0,x1,x2) => ({files: x0,title: x1,text: x2}),
      ...
      aN: (x0,x1) => ({files: x0,text: x1}),
      aO: (x0,x1,x2) => x0.revoke(x1,x2),
      aP: x0 => x0.files,
      b: (exn) => {
      ...
      bN: (x0,x1) => ({files: x0,title: x1}),
      bO: (x0,x1) => x0.getRandomValues(x1),
      bP: (x0,x1) => { x0.multiple = x1 },
      c: (c) =>
      ...
      cN: x0 => ({files: x0}),
      cO: (x0,x1,x2,x3) => x0.encrypt(x1,x2,x3),
      ...
      fN: () => ({}),
      fO: (x0,x1,x2,x3,x4,x5,x6,x7) => x0.unwrapKey(x1,x2,x3,x4,x5,x6,x7),
      fP: x0 => x0.getReader(),
      ...
      gN: (x0,x1,x2) => new File(x0,x1,x2),
      gO: (x0,x1,x2,x3,x4,x5) => x0.importKey(x1,x2,x3,x4,x5),
      gP: x0 => x0.value,
      ...
      hN: (x0,x1) => { x0.type = x1 },
      hO: (x0,x1,x2,x3) => x0.generateKey(x1,x2,x3),
      hP: x0 => x0.done,
      i: x0 => new Promise(x0),
      iB: o => {
        if (o === null || o === undefined) return 0;
      ...
      iO: (x0,x1,x2,x3,x4) => x0.wrapKey(x1,x2,x3,x4),
      iP: x0 => x0.read(),
      ...
      jO: (x0,x1,x2) => x0.exportKey(x1,x2),
      jP: x0 => x0.body,
      k: (constructor, args) => {
      ...
      mM: x0 => x0.abort(),
      mN: x0 => x0.head,
      mO: (x0,x1,x2,x3) => x0.decrypt(x1,x2,x3),
      mP: () => globalThis._flutter,
      n: (o0, o1) => [o0, o1],
      nB: o => {
        if (o === null || o === undefined) return 0;
      ...
      nM: x0 => x0.canvasKitMaximumSurfaces,
      nN: (o) => {
        const typeofValue = typeof o;
        return (typeofValue === 'object') ||
            typeofValue === 'function';
      },
      nO: x0 => x0.measurementId,
      o: (o0, o1, o2) => [o0, o1, o2],
      ...
      oM: x0 => x0.nextSibling,
      oN: (x0,x1) => x0.getAttribute(x1),
      oO: x0 => x0.appId,
      ...
      pM: (x0,x1) => x0.debug(x1),
      pN: (x0,x1) => x0.debug(x1),
      pO: x0 => x0.messagingSenderId,
      q: (x0,x1,x2) => { x0[x1] = x2 },
      ...
      rM: x0 => x0.location,
      rN: x0 => ({createScriptURL: x0}),
      rO: x0 => x0.databaseURL,
      s: () => globalThis,
      ...
      sM: (x0,x1) => x0.getModifierState(x1),
      ...
      vM: x0 => x0.ctrlKey,
      vN: (x0,x1) => x0.querySelectorAll(x1),
      vO: x0 => x0.options,
      w: (l, r) => l === r,
      ...
      xM: x0 => x0.code,
      xN: x0 => x0.nonce,
      xO: () => globalThis.firebase_core.getApps(),
      y: () => globalThis.Math,
