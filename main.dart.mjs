...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      AL: (x0,x1,x2,x3,x4) => x0.drawElements(x1,x2,x3,x4),
      AM: (x0,x1,x2) => x0.getUniformLocation(x1,x2),
      AN: (x0,x1) => x0.copyTo(x1),
      AO: (o, a) => o + a,
      AP: (x0,x1,x2) => x0.hasGrantedAllScopes(x1,x2),
      AQ: x0 => x0.name,
      ...
      BK: x0 => x0.send(),
      BL: (x0,x1) => x0.blendEquation(x1),
      BM: (x0,x1,x2) => x0.uniform1i(x1,x2),
      BN: (x0,x1) => { x0.height = x1 },
      BO: (x0,x1,x2) => ({files: x0,title: x1,text: x2}),
      BP: () => globalThis.google.accounts.oauth2,
      BQ: (x0,x1) => x0.item(x1),
      ...
      CK: x0 => x0.type,
      CL: (x0,x1,x2,x3,x4) => x0.blendFuncSeparate(x1,x2,x3,x4),
      CM: (x0,x1) => x0.createShader(x1),
      CN: (x0,x1) => { x0.width = x1 },
      CO: (x0,x1) => ({files: x0,text: x1}),
      CP: (x0,x1) => x0.revoke(x1),
      CQ: x0 => x0.length,
      ...
      DK: x0 => x0.response,
      DL: (x0,x1) => x0.depthMask(x1),
      DM: (x0,x1,x2) => x0.shaderSource(x1,x2),
      DN: (x0,x1) => x0.toDataURL(x1),
      DO: (x0,x1) => ({files: x0,title: x1}),
      ...
      EL: (x0,x1) => x0.enable(x1),
      EM: (x0,x1) => x0.compileShader(x1),
      EN: (x0,x1,x2,x3) => x0.drawImage(x1,x2,x3),
      EO: x0 => ({files: x0}),
      EP: (x0,x1,x2) => x0.revoke(x1,x2),
      EQ: (x0,x1) => { x0.multiple = x1 },
      F: () => new Error().stack,
      FB: (o, p, v) => o[p] = v,
      FC: o => {
        if (o === null || o === undefined) return 0;
      ...
      FK: x0 => x0.vendor,
      FL: (x0,x1) => x0.disable(x1),
      FM: (x0,x1,x2) => x0.getShaderParameter(x1,x2),
      FN: (x0,x1) => x0.getContext(x1),
      FO: (x0,x1) => ({title: x0,text: x1}),
      FP: (x0,x1) => x0.getRandomValues(x1),
      FQ: (x0,x1) => { x0.accept = x1 },
      ...
      GJ: x0 => ({childList: x0}),
      GK: x0 => x0.navigator,
      GL: (x0,x1,x2) => x0.bindSampler(x1,x2),
      GM: (x0,x1) => x0.getShaderInfoLog(x1),
      GN: x0 => x0.format,
      GO: x0 => ({text: x0}),
      GP: (x0,x1,x2,x3) => x0.encrypt(x1,x2,x3),
      GQ: (x0,x1) => { x0.type = x1 },
      ...
      HL: (x0,x1) => x0.activeTexture(x1),
      HM: (x0,x1) => x0.deleteVertexArray(x1),
      HN: (x0,x1) => x0.createImageBitmap(x1),
      HO: () => ({}),
      HP: x0 => x0.sessionStorage,
      HQ: x0 => x0.length,
      ...
      IK: (x0,x1) => x0.item(x1),
      IL: (x0,x1,x2) => x0.bindTexture(x1,x2),
      IM: (x0,x1) => x0.deleteBuffer(x1),
      IN: (x0,x1) => x0.getContext(x1),
      IO: (x0,x1,x2) => new File(x0,x1,x2),
      IP: x0 => x0.subtle,
      IQ: x0 => x0.getReader(),
      ...
      JL: (x0,x1,x2,x3,x4,x5,x6,x7,x8,x9) => x0.texImage2D(x1,x2,x3,x4,x5,x6,x7,x8,x9),
      JM: (x0,x1) => x0.deleteSampler(x1),
      JN: (x0,x1,x2,x3) => x0.drawImage(x1,x2,x3),
      JO: (x0,x1) => { x0.type = x1 },
      JP: (x0,x1,x2,x3,x4,x5,x6,x7) => x0.unwrapKey(x1,x2,x3,x4,x5,x6,x7),
      JQ: x0 => x0.value,
      K: o => o,
      ...
      KL: (x0,x1,x2,x3) => x0.texParameteri(x1,x2,x3),
      KM: (x0,x1,x2,x3) => x0.samplerParameteri(x1,x2,x3),
      ...
      KP: (x0,x1,x2,x3,x4,x5) => x0.importKey(x1,x2,x3,x4,x5),
      KQ: x0 => x0.done,
      L: o => {
      ...
      LK: x0 => x0.click(),
      LL: x0 => x0.getError(),
      LM: (x0,x1) => x0.isSampler(x1),
      LN: (x0,x1,x2,x3) => x0.toBlob(x1,x2,x3),
      LO: (wasmFunction,f) => finalizeWrapper(f, function(x0) { return wasmFunction(f,arguments.length,x0) }),
      LP: (x0,x1,x2,x3) => x0.generateKey(x1,x2,x3),
      LQ: x0 => x0.read(),
      M: x0 => x0.index,
      ...
      MJ: x0 => x0.height,
      MK: x0 => x0.length,
      ML: x0 => x0.createTexture(),
      MM: x0 => x0.createSampler(),
      MN: x0 => x0.arrayBuffer(),
      MO: (x0,x1) => { x0.src = x1 },
      MP: (x0,x1,x2,x3,x4) => x0.wrapKey(x1,x2,x3,x4),
      MQ: x0 => x0.body,
      N: o => String(o),
      ...
      NJ: x0 => x0.width,
      NK: x0 => x0.children,
      NL: (x0,x1) => x0.cullFace(x1),
      NM: (x0,x1,x2,x3) => x0.bufferData(x1,x2,x3),
      NN: x0 => x0.type,
      NO: (x0,x1) => { x0.type = x1 },
      NP: (x0,x1,x2) => x0.exportKey(x1,x2),
      NQ: x0 => x0.assetBase,
      O: o => o === undefined,
      ...
      OL: (x0,x1,x2) => x0.bindBuffer(x1,x2),
      OM: (x0,x1) => x0.isBuffer(x1),
      ON: x0 => x0.abort(),
      OO: x0 => x0.head,
      OP: x0 => x0.crypto,
      OQ: x0 => x0.loader,
      ...
      PL: (x0,x1,x2,x3) => x0.bufferSubData(x1,x2,x3),
      PM: x0 => x0.createBuffer(),
      PN: x0 => x0.canvasKitMaximumSurfaces,
      PO: (o) => {
        const typeofValue = typeof o;
        return (typeofValue === 'object') ||
            typeofValue === 'function';
      },
      PP: x0 => x0.isSecureContext,
      PQ: () => globalThis._flutter,
      ...
      QJ: x0 => x0.length,
      QK: (x0,x1) => { x0.href = x1 },
      QL: (x0,x1,x2,x3) => x0.bindBufferBase(x1,x2,x3),
      QM: (x0,x1) => x0.getParameter(x1),
      QN: x0 => x0.nextSibling,
      QO: (x0,x1) => x0.getAttribute(x1),
      QP: (x0,x1,x2,x3) => x0.decrypt(x1,x2,x3),
      R: o => o,
      ...
      RL: (x0,x1) => x0.bindVertexArray(x1),
      RM: (x0,x1) => x0.isVertexArray(x1),
      RN: (x0,x1) => x0.debug(x1),
      RO: (x0,x1) => x0.debug(x1),
      RP: x0 => x0.measurementId,
      S: (s, m) => {
        try {
      ...
      SL: (x0,x1) => x0.useProgram(x1),
      SM: (x0,x1) => x0.enableVertexAttribArray(x1),
      SN: x0 => x0.hostElement,
      ...
      TK: x0 => x0.body,
      TL: (x0,x1,x2,x3,x4) => x0.viewport(x1,x2,x3,x4),
      TM: (x0,x1,x2,x3,x4,x5,x6) => x0.vertexAttribPointer(x1,x2,x3,x4,x5,x6),
      TN: x0 => x0.location,
      TO: x0 => ({createScriptURL: x0}),
      TP: x0 => x0.messagingSenderId,
      ...
      UK: (x0,x1) => { x0.id = x1 },
      UL: (x0,x1,x2,x3,x4) => x0.clearColor(x1,x2,x3,x4),
      UM: x0 => x0.createVertexArray(),
      UN: (x0,x1) => x0.getModifierState(x1),
      UO: (x0,x1,x2) => x0.createPolicy(x1,x2),
      UP: x0 => x0.storageBucket,
      V: o => o,
      ...
      VI: x0 => x0.close(),
      VJ: x0 => x0.port2,
      VK: (x0,x1,x2,x3) => ({name: x0,iv: x1,additionalData: x2,tagLength: x3}),
      VL: (x0,x1) => x0.clearDepth(x1),
      VM: (wasmFunction,f) => finalizeWrapper(f, function(x0) { return wasmFunction(f,arguments.length,x0) }),
      VN: x0 => x0.metaKey,
      VO: (x0,x1) => x0.createScriptURL(x1),
      VP: x0 => x0.databaseURL,
      W: o => {
        if (o === undefined || o === null) return 0;
      ...
      WK: (x0,x1,x2) => globalThis.crypto.subtle.decrypt(x0,x1,x2),
      WL: (x0,x1) => x0.depthFunc(x1),
      WM: (wasmFunction,f) => finalizeWrapper(f, function(x0) { return wasmFunction(f,arguments.length,x0) }),
      WN: x0 => x0.altKey,
      WO: (x0,x1) => { x0.nonce = x1 },
      WP: x0 => x0.authDomain,
      X: x0 => x0.dotAll,
      ...
      XK: (x0,x1,x2,x3,x4) => globalThis.crypto.subtle.importKey(x0,x1,x2,x3,x4),
      XL: (x0,x1) => x0.frontFace(x1),
      XM: (x0,x1,x2) => x0.addEventListener(x1,x2),
      XN: x0 => x0.ctrlKey,
      XO: (x0,x1) => x0.querySelectorAll(x1),
      XP: x0 => x0.projectId,
      Y: x0 => x0.unicode,
      ...
      YJ: x0 => x0.length,
      YK: () => globalThis.window.isSecureContext,
      YL: (x0,x1) => x0.isTexture(x1),
      YM: (wasmFunction,f) => finalizeWrapper(f, function(x0,x1) { return wasmFunction(f,arguments.length,x0,x1) }),
      YN: x0 => x0.isComposing,
      YO: x0 => x0.nonce,
      YP: x0 => x0.apiKey,
      Z: x0 => x0.ignoreCase,
      ZB: (o, p) => o[p],
      ...
      ZJ: (o, t) => typeof o === t,
      ZK: () => globalThis.crypto.subtle,
      ZL: (x0,x1,x2) => x0.pixelStorei(x1,x2),
      ZM: x0 => x0.isContextLost(),
      ZN: x0 => x0.code,
      ZO: x0 => x0.document,
      ZP: x0 => x0.options,
      a: x0 => x0.multiline,
      ...
      bL: (x0,x1,x2,x3,x4,x5,x6) => x0.texImage2D(x1,x2,x3,x4,x5,x6),
      bM: (x0,x1,x2,x3,x4,x5,x6) => ({alpha: x0,depth: x1,stencil: x2,antialias: x3,premultipliedAlpha: x4,preserveDrawingBuffer: x5,powerPreference: x6}),
      bN: (wasmFunction,f) => finalizeWrapper(f, function(x0) { return wasmFunction(f,arguments.length,x0) }),
      bO: (x0,x1) => { x0.defer = x1 },
      bP: () => globalThis.firebase_core.getApps(),
      c: (c) =>
      ...
      cL: x0 => x0.height,
      cM: (x0,x1,x2) => x0.getContext(x1,x2),
      cN: x0 => x0.userAgent,
      cO: (x0,x1) => { x0.async = x1 },
      cP: x0 => x0.message,
      ...
      dK: (x0,x1) => x0.get(x1),
      dL: x0 => x0.width,
      dM: (x0,x1) => { x0.pointerEvents = x1 },
      dN: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      dO: x0 => x0.trustedTypes,
      dP: x0 => x0.code,
      ...
      eL: (x0,x1,x2) => ({imageOrientation: x0,premultiplyAlpha: x1,colorSpaceConversion: x2}),
      eM: (x0,x1) => { x0.backgroundColor = x1 },
      eN: (x0,x1,x2,x3,x4,x5) => ({clientId: x0,scope: x1,redirectURI: x2,state: x3,nonce: x4,usePopup: x5}),
      ...
      fL: (x0,x1,x2,x3,x4,x5) => ({imageOrientation: x0,premultiplyAlpha: x1,colorSpaceConversion: x2,resizeWidth: x3,resizeHeight: x4,resizeQuality: x5}),
      fM: (x0,x1) => { x0.display = x1 },
      fN: x0 => globalThis.AppleID.auth.init(x0),
      fO: (wasmFunction,f) => finalizeWrapper(f, function() { return wasmFunction(f,arguments.length) }),
      fP: (x0,x1,x2,x3,x4,x5,x6,x7) => ({apiKey: x0,authDomain: x1,databaseURL: x2,projectId: x3,storageBucket: x4,messagingSenderId: x5,measurementId: x6,appId: x7}),
      ...
      gK: x0 => x0.name,
      gL: (x0,x1,x2) => x0.createImageBitmap(x1,x2),
      gM: (x0,x1) => { x0.height = x1 },
      gN: () => globalThis.AppleID.auth.signIn(),
      gO: x0 => { globalThis.onGoogleLibraryLoad = x0 },
      gP: (x0,x1) => globalThis.firebase_core.initializeApp(x0,x1),
      ...
      hK: x0 => x0.statusText,
      hL: x0 => x0.clientHeight,
      hM: (x0,x1) => { x0.width = x1 },
      hN: x0 => x0.error,
      hO: x0 => x0.disableAutoSelect(),
      hP: x0 => globalThis.firebase_core.getApp(x0),
      i: x0 => new Promise(x0),
      iB: o => {
        if (o === null || o === undefined) return 0;
      ...
      iK: x0 => x0.url,
      iL: x0 => x0.clientWidth,
      iM: x0 => x0.style,
      iN: x0 => x0.lastName,
      iO: (x0,x1) => x0.initialize(x1),
      iP: () => globalThis.firebase_core.getApp(),
      ...
      kP: (x0,x1,x2) => globalThis.firebase_core.registerVersion(x0,x1,x2),
      l: x0 => new Array(x0),
      ...
      nN: x0 => x0.state,
      nO: (o, p) => p in o,
      nP: (x0,x1) => ({createScript: x0,createScriptURL: x1}),
      o: (o0, o1, o2) => [o0, o1, o2],
      ...
      oK: x0 => x0.cancel(),
      oL: x0 => x0.createProgram(),
      oM: x0 => x0.height,
      oN: x0 => x0.id_token,
      oO: x0 => x0.groups,
      oP: (x0,x1) => x0.createScriptURL(x1),
      ...
      pK: x0 => x0.body,
      pL: (x0,x1,x2) => x0.attachShader(x1,x2),
      pM: x0 => x0.width,
      pN: x0 => x0.code,
      pO: x0 => x0.requestAccessToken(),
      pP: (x0,x1,x2) => x0.createScript(x1,x2),
      q: (x0,x1,x2) => { x0[x1] = x2 },
      ...
      qJ: x0 => ({type: x0}),
      qK: x0 => x0.headers,
      qL: (x0,x1) => x0.linkProgram(x1),
      qM: x0 => x0.rasterEndMilliseconds,
      qN: x0 => x0.authorization,
      qO: (x0,x1) => x0.initTokenClient(x1),
      ...
      rK: x0 => x0.signal,
      rL: (x0,x1,x2) => x0.getProgramParameter(x1,x2),
      rM: x0 => x0.rasterStartMilliseconds,
      rN: (x0,x1) => x0.getItem(x1),
      ...
      sJ: () => new FileReader(),
      sK: x0 => new Blob(x0),
      sL: (x0,x1) => x0.getProgramInfoLog(x1),
      sM: x0 => x0.imageBitmaps,
      sN: x0 => x0.localStorage,
      sO: (wasmFunction,f) => finalizeWrapper(f, function(x0) { return wasmFunction(f,arguments.length,x0) }),
      sP: (x0,x1) => { x0.text = x1 },
      ...
      tK: (x0,x1) => x0.append(x1),
      tL: (x0,x1,x2) => x0.detachShader(x1,x2),
      tM: (x0,x1) => { x0.height = x1 },
      tN: (x0,x1) => x0.key(x1),
      tO: (x0,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10) => ({client_id: x0,callback: x1,scope: x2,include_granted_scopes: x3,prompt: x4,enable_granular_consent: x5,enable_serial_consent: x6,login_hint: x7,hd: x8,state: x9,error_callback: x10}),
      tP: (x0,x1) => { x0.text = x1 },
      ...
      uJ: x0 => x0.result,
      uK: x0 => x0.remove(),
      uL: (x0,x1) => x0.deleteShader(x1),
      uM: (x0,x1) => { x0.width = x1 },
      uN: x0 => x0.length,
      uO: x0 => x0.message,
      uP: x0 => x0.trustedTypes,
      ...
      vK: x0 => globalThis.URL.revokeObjectURL(x0),
      vL: (x0,x1) => x0.deleteProgram(x1),
      vM: x0 => x0.convertToBlob(),
      vN: (x0,x1) => x0.removeItem(x1),
      vO: x0 => x0.type,
      vP: (x0,x1) => { x0.crossOrigin = x1 },
      w: (l, r) => l === r,
      ...
      wL: (x0,x1,x2) => x0.getAttribLocation(x1,x2),
      wM: (x0,x1,x2) => new ImageData(x0,x1,x2),
      wN: (x0,x1,x2) => x0.setItem(x1,x2),
      wO: x0 => x0.error_description,
      ...
      xL: (x0,x1,x2) => x0.getUniformBlockIndex(x1,x2),
      xM: (x0,x1) => x0.getContext(x1),
      xN: (x0,x1) => x0.canShare(x1),
      xO: x0 => x0.expires_in,
      xP: x0 => x0.message,
      y: () => globalThis.Math,
      ...
      yL: (x0,x1,x2,x3) => x0.getActiveUniformBlockParameter(x1,x2,x3),
      yM: (x0,x1) => new OffscreenCanvas(x0,x1),
      yN: (x0,x1) => x0.share(x1),
      yO: x0 => x0.error,
      yP: x0 => x0.lastModified,
      ...
      zK: (x0,x1) => x0.clear(x1),
      zL: (x0,x1,x2,x3) => x0.uniformBlockBinding(x1,x2,x3),
      zM: x0 => x0.allocationSize(),
      zN: x0 => x0.message,
      zO: x0 => x0.access_token,
      zP: x0 => x0.size,
