...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      AK: x0 => x0.response,
      AL: (x0,x1) => x0.disable(x1),
      AM: (x0,x1,x2) => x0.getShaderParameter(x1,x2),
      AN: (x0,x1) => x0.getContext(x1),
      AO: (x0,x1) => ({title: x0,text: x1}),
      AP: (x0,x1) => x0.getRandomValues(x1),
      AQ: (x0,x1) => { x0.accept = x1 },
      ...
      BL: (x0,x1,x2) => x0.bindSampler(x1,x2),
      BM: (x0,x1) => x0.getShaderInfoLog(x1),
      BN: x0 => x0.format,
      BO: x0 => ({text: x0}),
      BP: (x0,x1,x2,x3) => x0.encrypt(x1,x2,x3),
      BQ: (x0,x1) => { x0.type = x1 },
      ...
      CK: x0 => x0.vendor,
      CL: (x0,x1) => x0.activeTexture(x1),
      CM: (x0,x1) => x0.deleteVertexArray(x1),
      CN: (x0,x1) => x0.createImageBitmap(x1),
      CO: () => ({}),
      CP: x0 => x0.sessionStorage,
      CQ: x0 => x0.length,
      ...
      DK: x0 => x0.navigator,
      DL: (x0,x1,x2) => x0.bindTexture(x1,x2),
      DM: (x0,x1) => x0.deleteBuffer(x1),
      DN: (x0,x1) => x0.getContext(x1),
      DO: (x0,x1,x2) => new File(x0,x1,x2),
      DP: x0 => x0.subtle,
      DQ: x0 => x0.getReader(),
      E: (exn) => {
      ...
      EL: (x0,x1,x2,x3,x4,x5,x6,x7,x8,x9) => x0.texImage2D(x1,x2,x3,x4,x5,x6,x7,x8,x9),
      EM: (x0,x1) => x0.deleteSampler(x1),
      EN: (x0,x1,x2,x3) => x0.drawImage(x1,x2,x3),
      EO: (x0,x1) => { x0.type = x1 },
      EP: (x0,x1,x2,x3,x4,x5,x6,x7) => x0.unwrapKey(x1,x2,x3,x4,x5,x6,x7),
      EQ: x0 => x0.value,
      F: () => new Error().stack,
      FB: (o, p, v) => o[p] = v,
      FC: o => {
      ...
      FL: (x0,x1,x2,x3) => x0.texParameteri(x1,x2,x3),
      FM: (x0,x1,x2,x3) => x0.samplerParameteri(x1,x2,x3),
      ...
      FP: (x0,x1,x2,x3,x4,x5) => x0.importKey(x1,x2,x3,x4,x5),
      FQ: x0 => x0.done,
      ...
      GK: x0 => ({type: x0}),
      GL: x0 => x0.getError(),
      GM: (x0,x1) => x0.isSampler(x1),
      GN: (x0,x1,x2,x3) => x0.toBlob(x1,x2,x3),
      GO: (wasmFunction,f) => finalizeWrapper(f, function(x0) { return wasmFunction(f,arguments.length,x0) }),
      GP: (x0,x1,x2,x3) => x0.generateKey(x1,x2,x3),
      GQ: x0 => x0.read(),
      ...
      HK: (x0,x1) => new Blob(x0,x1),
      HL: x0 => x0.createTexture(),
      HM: x0 => x0.createSampler(),
      HN: x0 => x0.arrayBuffer(),
      HO: (x0,x1) => { x0.src = x1 },
      HP: (x0,x1,x2,x3,x4) => x0.wrapKey(x1,x2,x3,x4),
      HQ: x0 => x0.body,
      ...
      IK: (x0,x1) => x0.item(x1),
      IL: (x0,x1) => x0.cullFace(x1),
      IM: (x0,x1,x2,x3) => x0.bufferData(x1,x2,x3),
      IN: x0 => x0.type,
      IO: (x0,x1) => { x0.type = x1 },
      IP: (x0,x1,x2) => x0.exportKey(x1,x2),
      IQ: x0 => x0.assetBase,
      ...
      JL: (x0,x1,x2) => x0.bindBuffer(x1,x2),
      JM: (x0,x1) => x0.isBuffer(x1),
      JN: x0 => x0.abort(),
      JO: x0 => x0.head,
      JP: x0 => x0.crypto,
      JQ: x0 => x0.loader,
      ...
      KL: (x0,x1,x2,x3) => x0.bufferSubData(x1,x2,x3),
      KM: x0 => x0.createBuffer(),
      KN: x0 => x0.canvasKitMaximumSurfaces,
      KO: (o) => {
        const typeofValue = typeof o;
        return (typeofValue === 'object') ||
            typeofValue === 'function';
      },
      KP: x0 => x0.isSecureContext,
      KQ: () => globalThis._flutter,
      L: o => {
      ...
      LJ: x0 => x0.disconnect(),
      LK: x0 => x0.click(),
      LL: (x0,x1,x2,x3) => x0.bindBufferBase(x1,x2,x3),
      LM: (x0,x1) => x0.getParameter(x1),
      LN: x0 => x0.nextSibling,
      LO: (x0,x1) => x0.getAttribute(x1),
      LP: (x0,x1,x2,x3) => x0.decrypt(x1,x2,x3),
      M: x0 => x0.index,
      ...
      MJ: x0 => x0.height,
      MK: x0 => x0.length,
      ML: (x0,x1) => x0.bindVertexArray(x1),
      MM: (x0,x1) => x0.isVertexArray(x1),
      MN: (x0,x1) => x0.debug(x1),
      MO: (x0,x1) => x0.debug(x1),
      MP: x0 => x0.measurementId,
      N: o => String(o),
      ...
      NJ: x0 => x0.width,
      NK: x0 => x0.children,
      NL: (x0,x1) => x0.useProgram(x1),
      NM: (x0,x1) => x0.enableVertexAttribArray(x1),
      NN: x0 => x0.hostElement,
      ...
      OL: (x0,x1,x2,x3,x4) => x0.viewport(x1,x2,x3,x4),
      OM: (x0,x1,x2,x3,x4,x5,x6) => x0.vertexAttribPointer(x1,x2,x3,x4,x5,x6),
      ON: x0 => x0.location,
      OO: x0 => ({createScriptURL: x0}),
      OP: x0 => x0.messagingSenderId,
      P: (x0,x1) => x0.exec(x1),
      ...
      PL: (x0,x1,x2,x3,x4) => x0.clearColor(x1,x2,x3,x4),
      PM: x0 => x0.createVertexArray(),
      PN: (x0,x1) => x0.getModifierState(x1),
      PO: (x0,x1,x2) => x0.createPolicy(x1,x2),
      PP: x0 => x0.storageBucket,
      ...
      SL: (x0,x1) => x0.frontFace(x1),
      SM: (x0,x1,x2) => x0.addEventListener(x1,x2),
      SN: x0 => x0.ctrlKey,
      SO: (x0,x1) => x0.querySelectorAll(x1),
      SP: x0 => x0.projectId,
      ...
      TK: x0 => x0.body,
      TL: (x0,x1) => x0.isTexture(x1),
      TM: (wasmFunction,f) => finalizeWrapper(f, function(x0,x1) { return wasmFunction(f,arguments.length,x0,x1) }),
      TN: x0 => x0.isComposing,
      TO: x0 => x0.nonce,
      TP: x0 => x0.apiKey,
      ...
      UK: (x0,x1) => { x0.id = x1 },
      UL: (x0,x1,x2) => x0.pixelStorei(x1,x2),
      UM: x0 => x0.isContextLost(),
      UN: x0 => x0.code,
      UO: x0 => x0.document,
      UP: x0 => x0.options,
      V: o => o,
      ...
      WL: (x0,x1,x2,x3,x4,x5,x6) => x0.texImage2D(x1,x2,x3,x4,x5,x6),
      WM: (x0,x1,x2,x3,x4,x5,x6) => ({alpha: x0,depth: x1,stencil: x2,antialias: x3,premultipliedAlpha: x4,preserveDrawingBuffer: x5,powerPreference: x6}),
      WN: (wasmFunction,f) => finalizeWrapper(f, function(x0) { return wasmFunction(f,arguments.length,x0) }),
      WO: (x0,x1) => { x0.defer = x1 },
      WP: () => globalThis.firebase_core.getApps(),
      X: x0 => x0.dotAll,
      ...
      XL: x0 => x0.height,
      XM: (x0,x1,x2) => x0.getContext(x1,x2),
      XN: x0 => x0.userAgent,
      XO: (x0,x1) => { x0.async = x1 },
      XP: x0 => x0.message,
      Y: x0 => x0.unicode,
      ...
      YK: (x0,x1) => x0.get(x1),
      YL: x0 => x0.width,
      YM: (x0,x1) => { x0.pointerEvents = x1 },
      YN: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      YO: x0 => x0.trustedTypes,
      YP: x0 => x0.code,
      Z: x0 => x0.ignoreCase,
      ZB: (o, p) => o[p],
      ...
      ZL: (x0,x1,x2) => ({imageOrientation: x0,premultiplyAlpha: x1,colorSpaceConversion: x2}),
      ZM: (x0,x1) => { x0.backgroundColor = x1 },
      ZN: (x0,x1,x2,x3,x4,x5) => ({clientId: x0,scope: x1,redirectURI: x2,state: x3,nonce: x4,usePopup: x5}),
      ZO: x0 => x0.trustedTypes,
      ZP: x0 => x0.name,
      a: x0 => x0.multiline,
      ...
      aL: (x0,x1,x2,x3,x4,x5) => ({imageOrientation: x0,premultiplyAlpha: x1,colorSpaceConversion: x2,resizeWidth: x3,resizeHeight: x4,resizeQuality: x5}),
      aM: (x0,x1) => { x0.display = x1 },
      aN: x0 => globalThis.AppleID.auth.init(x0),
      aO: (wasmFunction,f) => finalizeWrapper(f, function() { return wasmFunction(f,arguments.length) }),
      aP: (x0,x1,x2,x3,x4,x5,x6,x7) => ({apiKey: x0,authDomain: x1,databaseURL: x2,projectId: x3,storageBucket: x4,messagingSenderId: x5,measurementId: x6,appId: x7}),
      b: (exn) => {
      ...
      bJ: x0 => x0.port1,
      bK: x0 => x0.name,
      bL: (x0,x1,x2) => x0.createImageBitmap(x1,x2),
      bM: (x0,x1) => { x0.height = x1 },
      bN: () => globalThis.AppleID.auth.signIn(),
      bO: x0 => { globalThis.onGoogleLibraryLoad = x0 },
      bP: (x0,x1) => globalThis.firebase_core.initializeApp(x0,x1),
      c: (c) =>
      ...
      cK: x0 => x0.statusText,
      cL: x0 => x0.clientHeight,
      cM: (x0,x1) => { x0.width = x1 },
      cN: x0 => x0.error,
      cO: x0 => x0.disableAutoSelect(),
      cP: x0 => globalThis.firebase_core.getApp(x0),
      ...
      dJ: x0 => new Worker(x0),
      dK: x0 => x0.url,
      dL: x0 => x0.clientWidth,
      dM: x0 => x0.style,
      dN: x0 => x0.lastName,
      dO: (x0,x1) => x0.initialize(x1),
      dP: () => globalThis.firebase_core.getApp(),
      ...
      fP: (x0,x1,x2) => globalThis.firebase_core.registerVersion(x0,x1,x2),
      ...
      gK: x0 => x0.read(),
      gL: (x0,x1) => { x0.width = x1 },
      gM: (x0,x1,x2,x3) => x0.putImageData(x1,x2,x3),
      gN: x0 => x0.email,
      gO: x0 => x0.error,
      ...
      iK: x0 => x0.done,
      iL: x0 => x0.width,
      iM: (x0,x1) => x0.transferFromImageBitmap(x1),
      iN: x0 => x0.state,
      iO: (o, p) => p in o,
      iP: (x0,x1) => ({createScript: x0,createScriptURL: x1}),
      ...
      jJ: x0 => x0.port,
      jK: x0 => x0.cancel(),
      jL: x0 => x0.createProgram(),
      jM: x0 => x0.height,
      jN: x0 => x0.id_token,
      jO: x0 => x0.groups,
      jP: (x0,x1) => x0.createScriptURL(x1),
      k: (constructor, args) => {
      ...
      kK: x0 => x0.body,
      kL: (x0,x1,x2) => x0.attachShader(x1,x2),
      kM: x0 => x0.width,
      kN: x0 => x0.code,
      kO: x0 => x0.requestAccessToken(),
      kP: (x0,x1,x2) => x0.createScript(x1,x2),
      l: x0 => new Array(x0),
      ...
      lK: x0 => x0.headers,
      lL: (x0,x1) => x0.linkProgram(x1),
      lM: x0 => x0.rasterEndMilliseconds,
      lN: x0 => x0.authorization,
      lO: (x0,x1) => x0.initTokenClient(x1),
      ...
      mK: x0 => x0.signal,
      mL: (x0,x1,x2) => x0.getProgramParameter(x1,x2),
      mM: x0 => x0.rasterStartMilliseconds,
      mN: (x0,x1) => x0.getItem(x1),
      ...
      nK: x0 => new Blob(x0),
      nL: (x0,x1) => x0.getProgramInfoLog(x1),
      nM: x0 => x0.imageBitmaps,
      nN: x0 => x0.localStorage,
      nO: (wasmFunction,f) => finalizeWrapper(f, function(x0) { return wasmFunction(f,arguments.length,x0) }),
      nP: (x0,x1) => { x0.text = x1 },
      o: (o0, o1, o2) => [o0, o1, o2],
      ...
      oK: (x0,x1) => x0.append(x1),
      oL: (x0,x1,x2) => x0.detachShader(x1,x2),
      oM: (x0,x1) => { x0.height = x1 },
      oN: (x0,x1) => x0.key(x1),
      oO: (x0,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10) => ({client_id: x0,callback: x1,scope: x2,include_granted_scopes: x3,prompt: x4,enable_granular_consent: x5,enable_serial_consent: x6,login_hint: x7,hd: x8,state: x9,error_callback: x10}),
      oP: (x0,x1) => { x0.text = x1 },
      ...
      pJ: () => new FileReader(),
      pK: x0 => x0.remove(),
      pL: (x0,x1) => x0.deleteShader(x1),
      pM: (x0,x1) => { x0.width = x1 },
      pN: x0 => x0.length,
      pO: x0 => x0.message,
      pP: x0 => x0.trustedTypes,
      q: (x0,x1,x2) => { x0[x1] = x2 },
      ...
      qJ: (x0,x1) => x0.readAsArrayBuffer(x1),
      qK: x0 => globalThis.URL.revokeObjectURL(x0),
      qL: (x0,x1) => x0.deleteProgram(x1),
      qM: x0 => x0.convertToBlob(),
      qN: (x0,x1) => x0.removeItem(x1),
      qO: x0 => x0.type,
      qP: (x0,x1) => { x0.crossOrigin = x1 },
      r: (o, p) => o[p],
      rB: o => {
        if (o === null || o === undefined) return 0;
      ...
      rJ: x0 => x0.result,
      rK: (x0,x1,x2) => x0.setAttribute(x1,x2),
      rL: (x0,x1,x2) => x0.getAttribLocation(x1,x2),
      rM: (x0,x1,x2) => new ImageData(x0,x1,x2),
      rN: (x0,x1,x2) => x0.setItem(x1,x2),
      rO: x0 => x0.error_description,
      ...
      sL: (x0,x1,x2) => x0.getUniformBlockIndex(x1,x2),
      sM: (x0,x1) => x0.getContext(x1),
      ...
      tK: (x0,x1) => x0.deleteTexture(x1),
      tL: (x0,x1,x2,x3) => x0.getActiveUniformBlockParameter(x1,x2,x3),
      tM: (x0,x1) => new OffscreenCanvas(x0,x1),
      tN: (x0,x1) => x0.share(x1),
      tO: x0 => x0.error,
      tP: x0 => x0.lastModified,
      ...
      uH: x0 => x0.current(),
      uI: (x0,x1) => { x0.min = x1 },
      uJ: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      uK: (x0,x1) => x0.clear(x1),
      uL: (x0,x1,x2,x3) => x0.uniformBlockBinding(x1,x2,x3),
      uM: x0 => x0.allocationSize(),
      uN: x0 => x0.message,
      uO: x0 => x0.access_token,
      uP: x0 => x0.size,
      ...
      vK: (x0,x1,x2,x3,x4) => x0.drawElements(x1,x2,x3,x4),
      vL: (x0,x1,x2) => x0.getUniformLocation(x1,x2),
      vM: (x0,x1) => x0.copyTo(x1),
      vN: (o, a) => o + a,
      vO: (x0,x1,x2) => x0.hasGrantedAllScopes(x1,x2),
      vP: x0 => x0.name,
      w: (l, r) => l === r,
      ...
      wK: (x0,x1) => x0.blendEquation(x1),
      wL: (x0,x1,x2) => x0.uniform1i(x1,x2),
      wM: (x0,x1) => { x0.height = x1 },
      wN: (x0,x1,x2) => ({files: x0,title: x1,text: x2}),
      wO: () => globalThis.google.accounts.oauth2,
      wP: (x0,x1) => x0.item(x1),
      x: x0 => x0.random(),
      xB: o => {
        if (o === null || o === undefined) return 0;
      ...
      xK: (x0,x1,x2,x3,x4) => x0.blendFuncSeparate(x1,x2,x3,x4),
      xL: (x0,x1) => x0.createShader(x1),
      xM: (x0,x1) => { x0.width = x1 },
      xN: (x0,x1) => ({files: x0,text: x1}),
      xO: (x0,x1) => x0.revoke(x1),
      xP: x0 => x0.length,
      y: () => globalThis.Math,
      ...
      yJ: x0 => x0.send(),
      yK: (x0,x1) => x0.depthMask(x1),
      yL: (x0,x1,x2) => x0.shaderSource(x1,x2),
      yM: (x0,x1) => x0.toDataURL(x1),
      yN: (x0,x1) => ({files: x0,title: x1}),
      ...
      zJ: x0 => x0.type,
      zK: (x0,x1) => x0.enable(x1),
      zL: (x0,x1) => x0.compileShader(x1),
      zM: (x0,x1,x2,x3) => x0.drawImage(x1,x2,x3),
      zN: x0 => ({files: x0}),
      zO: (x0,x1,x2) => x0.revoke(x1,x2),
      zP: (x0,x1) => { x0.multiple = x1 },
